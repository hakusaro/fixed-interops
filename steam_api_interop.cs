...
IntPtr m_SteamClient;

public override IntPtr GetIntPtr() { return m_SteamClient; }

private void CheckIfUsable()
{
	if (m_SteamClient == IntPtr.Zero)
	{
...
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_CreateSteamPipe(m_SteamClient);
	return result;
}
public override bool BReleaseSteamPipe(uint hSteamPipe)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_BReleaseSteamPipe(m_SteamClient, hSteamPipe);
	return result;
}
public override uint ConnectToGlobalUser(uint hSteamPipe)
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_ConnectToGlobalUser(m_SteamClient, hSteamPipe);
	return result;
}
public override uint CreateLocalUser(ref uint phSteamPipe,uint eAccountType)
{
	CheckIfUsable();
	phSteamPipe = 0;
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_CreateLocalUser(m_SteamClient, ref phSteamPipe, eAccountType);
	return result;
}
public override void ReleaseUser(uint hSteamPipe,uint hUser)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_ReleaseUser(m_SteamClient, hSteamPipe, hUser);
}
public override ISteamUser GetISteamUser(uint hSteamUser,uint hSteamPipe,string pchVersion)
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_GetISteamUser(m_SteamClient, hSteamUser, hSteamPipe, pchVersion);
...
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_GetISteamGameServer(m_SteamClient, hSteamUser, hSteamPipe, pchVersion);
...
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_SetLocalIPBinding(m_SteamClient, unIP, usPort);
}
public override ISteamFriends GetISteamFriends(uint hSteamUser,uint hSteamPipe,string pchVersion)
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_GetISteamFriends(m_SteamClient, hSteamUser, hSteamPipe, pchVersion);
...
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_GetISteamUtils(m_SteamClient, hSteamPipe, pchVersion);
...
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_GetISteamMatchmaking(m_SteamClient, hSteamUser, hSteamPipe, pchVersion);
...
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_GetISteamMatchmakingServers(m_SteamClient, hSteamUser, hSteamPipe, pchVersion);
...
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_GetISteamGenericInterface(m_SteamClient, hSteamUser, hSteamPipe, pchVersion);
...
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_GetISteamUserStats(m_SteamClient, hSteamUser, hSteamPipe, pchVersion);
...
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_GetISteamGameServerStats(m_SteamClient, hSteamuser, hSteamPipe, pchVersion);
...
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_GetISteamApps(m_SteamClient, hSteamUser, hSteamPipe, pchVersion);
...
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_GetISteamNetworking(m_SteamClient, hSteamUser, hSteamPipe, pchVersion);
...
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_GetISteamRemoteStorage(m_SteamClient, hSteamuser, hSteamPipe, pchVersion);
...
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_GetISteamScreenshots(m_SteamClient, hSteamuser, hSteamPipe, pchVersion);
	return (ISteamScreenshots) Marshal.PtrToStructure(result, typeof(ISteamScreenshots));
}
public override void RunFrame()
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_RunFrame(m_SteamClient);
}
public override uint GetIPCCallCount()
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_GetIPCCallCount(m_SteamClient);
	return result;
}
public override void SetWarningMessageHook(IntPtr pFunction)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_SetWarningMessageHook(m_SteamClient, pFunction);
}
public override bool BShutdownIfAllPipesClosed()
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_BShutdownIfAllPipesClosed(m_SteamClient);
	return result;
}
public override ISteamHTTP GetISteamHTTP(uint hSteamuser,uint hSteamPipe,string pchVersion)
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_GetISteamHTTP(m_SteamClient, hSteamuser, hSteamPipe, pchVersion);
...
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_GetISteamUnifiedMessages(m_SteamClient, hSteamuser, hSteamPipe, pchVersion);
...
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_GetISteamController(m_SteamClient, hSteamUser, hSteamPipe, pchVersion);
...
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_GetISteamUGC(m_SteamClient, hSteamUser, hSteamPipe, pchVersion);
...
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_GetISteamAppList(m_SteamClient, hSteamUser, hSteamPipe, pchVersion);
...
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_GetISteamMusic(m_SteamClient, hSteamuser, hSteamPipe, pchVersion);
...
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_GetISteamMusicRemote(m_SteamClient, hSteamuser, hSteamPipe, pchVersion);
...
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_GetISteamHTMLSurface(m_SteamClient, hSteamuser, hSteamPipe, pchVersion);
...
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_Set_SteamAPI_CPostAPIResultInProcess(m_SteamClient, func);
}
public override void Remove_SteamAPI_CPostAPIResultInProcess(IntPtr func)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_Remove_SteamAPI_CPostAPIResultInProcess(m_SteamClient, func);
}
public override void Set_SteamAPI_CCheckCallbackRegisteredInProcess(IntPtr func)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_Set_SteamAPI_CCheckCallbackRegisteredInProcess(m_SteamClient, func);
}
public override ISteamInventory GetISteamInventory(uint hSteamuser,uint hSteamPipe,string pchVersion)
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_GetISteamInventory(m_SteamClient, hSteamuser, hSteamPipe, pchVersion);
...
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamClient_GetISteamVideo(m_SteamClient, hSteamuser, hSteamPipe, pchVersion);
...
public override IntPtr GetIntPtr() { return m_SteamUser; }

private void CheckIfUsable()
{
	if (m_SteamUser == IntPtr.Zero)
	{
		throw new Exception("Steam Pointer not configured");
	}
}
...
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUser_GetHSteamUser(m_SteamUser);
	return result;
}
public override bool BLoggedOn()
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUser_BLoggedOn(m_SteamUser);
	return result;
}
public override ulong GetSteamID()
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUser_GetSteamID(m_SteamUser);
	return result;
}
...
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUser_InitiateGameConnection(m_SteamUser, pAuthBlob, cbMaxAuthBlob, steamIDGameServer, unIPServer, usPortServer, bSecure);
	return result;
}
public override void TerminateGameConnection(uint unIPServer,char usPortServer)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUser_TerminateGameConnection(m_SteamUser, unIPServer, usPortServer);
}
public override void TrackAppUsageEvent(ulong gameID,int eAppUsageEvent,string pchExtraInfo)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUser_TrackAppUsageEvent(m_SteamUser, gameID, eAppUsageEvent, pchExtraInfo);
}
public override bool GetUserDataFolder(string pchBuffer,int cubBuffer)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUser_GetUserDataFolder(m_SteamUser,pchBuffer,cubBuffer);
	return result;
}
public override void StartVoiceRecording()
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUser_StartVoiceRecording(m_SteamUser);
}
public override void StopVoiceRecording()
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUser_StopVoiceRecording(m_SteamUser);
}
public override uint GetAvailableVoice(ref uint pcbCompressed,ref uint pcbUncompressed,uint nUncompressedVoiceDesiredSampleRate)
{
	...
	pcbCompressed = 0;
	pcbUncompressed = 0;
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUser_GetAvailableVoice(m_SteamUser,ref pcbCompressed,ref pcbUncompressed,nUncompressedVoiceDesiredSampleRate);
	return result;
}
public override uint GetVoice(bool bWantCompressed,IntPtr pDestBuffer,uint cbDestBufferSize,ref uint nBytesWritten,bool bWantUncompressed,IntPtr pUncompressedDestBuffer,uint cbUncompressedDestBufferSize,ref uint nUncompressBytesWritten,uint nUncompressedVoiceDesiredSampleRate)
{
	...
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUser_GetVoice(m_SteamUser,bWantCompressed,pDestBuffer,cbDestBufferSize,ref nBytesWritten,bWantUncompressed,pUncompressedDestBuffer,cbUncompressedDestBufferSize,ref nUncompressBytesWritten,nUncompressedVoiceDesiredSampleRate);
	return result;
}
public override uint DecompressVoice(IntPtr pCompressed,uint cbCompressed,IntPtr pDestBuffer,uint cbDestBufferSize,ref uint nBytesWritten,uint nDesiredSampleRate)
{
	CheckIfUsable();
	nBytesWritten = 0;
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUser_DecompressVoice(m_SteamUser,pCompressed,cbCompressed,pDestBuffer,cbDestBufferSize,ref nBytesWritten,nDesiredSampleRate);
	return result;
}
public override uint GetVoiceOptimalSampleRate()
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUser_GetVoiceOptimalSampleRate(m_SteamUser);
	return result;
}
public override uint GetAuthSessionTicket(IntPtr pTicket,int cbMaxTicket,ref uint pcbTicket)
{
	CheckIfUsable();
	pcbTicket = 0;
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUser_GetAuthSessionTicket(m_SteamUser,pTicket,cbMaxTicket,ref pcbTicket);
	return result;
}
public override uint BeginAuthSession(IntPtr pAuthTicket,int cbAuthTicket,ulong steamID)
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUser_BeginAuthSession(m_SteamUser,pAuthTicket,cbAuthTicket,steamID);
	return result;
}
public override void EndAuthSession(ulong steamID)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUser_EndAuthSession(m_SteamUser,steamID);
}
public override void CancelAuthTicket(uint hAuthTicket)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUser_CancelAuthTicket(m_SteamUser,hAuthTicket);
}
public override uint UserHasLicenseForApp(ulong steamID,uint appID)
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUser_UserHasLicenseForApp(m_SteamUser,steamID,appID);
	return result;
}
public override bool BIsBehindNAT()
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUser_BIsBehindNAT(m_SteamUser);
	return result;
}
public override void AdvertiseGame(ulong steamIDGameServer,uint unIPServer,char usPortServer)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUser_AdvertiseGame(m_SteamUser,steamIDGameServer,unIPServer,usPortServer);
}
public override ulong RequestEncryptedAppTicket(IntPtr pDataToInclude,int cbDataToInclude)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUser_RequestEncryptedAppTicket(m_SteamUser,pDataToInclude,cbDataToInclude);
	return result;
}
public override bool GetEncryptedAppTicket(IntPtr pTicket,int cbMaxTicket,ref uint pcbTicket)
{
	CheckIfUsable();
	pcbTicket = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUser_GetEncryptedAppTicket(m_SteamUser,pTicket,cbMaxTicket,ref pcbTicket);
	return result;
}
public override int GetGameBadgeLevel(int nSeries,bool bFoil)
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUser_GetGameBadgeLevel(m_SteamUser,nSeries,bFoil);
	return result;
}
public override int GetPlayerSteamLevel()
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUser_GetPlayerSteamLevel(m_SteamUser);
	return result;
}
public override ulong RequestStoreAuthURL(string pchRedirectURL)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUser_RequestStoreAuthURL(m_SteamUser,pchRedirectURL);
	return result;
}
}
...
IntPtr m_SteamFriends;

public override IntPtr GetIntPtr() { return m_SteamFriends; }

private void CheckIfUsable()
{
	if (m_SteamFriends == IntPtr.Zero)
	{
		throw new Exception("Steam Pointer not configured");
	}
}
...
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetPersonaName(m_SteamFriends);
	return (string) Marshal.PtrToStructure(result, typeof(string));
}
public override ulong SetPersonaName(string pchPersonaName)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_SetPersonaName(m_SteamFriends,pchPersonaName);
	return result;
}
public override uint GetPersonaState()
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetPersonaState(m_SteamFriends);
	return result;
}
public override int GetFriendCount(int iFriendFlags)
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetFriendCount(m_SteamFriends,iFriendFlags);
	return result;
}
public override ulong GetFriendByIndex(int iFriend,int iFriendFlags)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetFriendByIndex(m_SteamFriends,iFriend,iFriendFlags);
	return result;
}
public override uint GetFriendRelationship(ulong steamIDFriend)
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetFriendRelationship(m_SteamFriends,steamIDFriend);
	return result;
}
public override uint GetFriendPersonaState(ulong steamIDFriend)
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetFriendPersonaState(m_SteamFriends,steamIDFriend);
	return result;
}
public override string GetFriendPersonaName(ulong steamIDFriend)
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetFriendPersonaName(m_SteamFriends,steamIDFriend);
	return (string) Marshal.PtrToStructure(result, typeof(string));
}
public override bool GetFriendGamePlayed(ulong steamIDFriend,out FriendGameInfo_t pFriendGameInfo)
{
	...
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetFriendGamePlayed(m_SteamFriends,steamIDFriend,ref pFriendGameInfo);
	return result;
}
public override string GetFriendPersonaNameHistory(ulong steamIDFriend,int iPersonaName)
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetFriendPersonaNameHistory(m_SteamFriends,steamIDFriend,iPersonaName);
	return (string) Marshal.PtrToStructure(result, typeof(string));
}
public override int GetFriendSteamLevel(ulong steamIDFriend)
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetFriendSteamLevel(m_SteamFriends,steamIDFriend);
	return result;
}
public override string GetPlayerNickname(ulong steamIDPlayer)
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetPlayerNickname(m_SteamFriends,steamIDPlayer);
	return (string) Marshal.PtrToStructure(result, typeof(string));
}
public override int GetFriendsGroupCount()
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetFriendsGroupCount(m_SteamFriends);
	return result;
}
public override char GetFriendsGroupIDByIndex(int iFG)
{
	CheckIfUsable();
	char result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetFriendsGroupIDByIndex(m_SteamFriends,iFG);
	return result;
}
public override string GetFriendsGroupName(char friendsGroupID)
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetFriendsGroupName(m_SteamFriends,friendsGroupID);
	return (string) Marshal.PtrToStructure(result, typeof(string));
}
public override int GetFriendsGroupMembersCount(char friendsGroupID)
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetFriendsGroupMembersCount(m_SteamFriends,friendsGroupID);
	return result;
}
public override void GetFriendsGroupMembersList(char friendsGroupID,out CSteamID [] pOutSteamIDMembers)
{
	...
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetFriendsGroupMembersList(m_SteamFriends,friendsGroupID,pOutSteamIDMembers,nMembersCount);
}
public override bool HasFriend(ulong steamIDFriend,int iFriendFlags)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_HasFriend(m_SteamFriends,steamIDFriend,iFriendFlags);
	return result;
}
public override int GetClanCount()
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetClanCount(m_SteamFriends);
	return result;
}
public override ulong GetClanByIndex(int iClan)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetClanByIndex(m_SteamFriends,iClan);
	return result;
}
public override string GetClanName(ulong steamIDClan)
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetClanName(m_SteamFriends,steamIDClan);
	return (string) Marshal.PtrToStructure(result, typeof(string));
}
public override string GetClanTag(ulong steamIDClan)
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetClanTag(m_SteamFriends,steamIDClan);
	return (string) Marshal.PtrToStructure(result, typeof(string));
}
public override bool GetClanActivityCounts(ulong steamIDClan,ref int pnOnline,ref int pnInGame,ref int pnChatting)
{
	...
	pnInGame = 0;
	pnChatting = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetClanActivityCounts(m_SteamFriends,steamIDClan,ref pnOnline,ref pnInGame,ref pnChatting);
	return result;
}
public override ulong DownloadClanActivityCounts(CSteamID [] psteamIDClans)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_DownloadClanActivityCounts(m_SteamFriends,psteamIDClans,(int) psteamIDClans.Length);
	return result;
}
public override int GetFriendCountFromSource(ulong steamIDSource)
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetFriendCountFromSource(m_SteamFriends,steamIDSource);
	return result;
}
public override ulong GetFriendFromSourceByIndex(ulong steamIDSource,int iFriend)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetFriendFromSourceByIndex(m_SteamFriends,steamIDSource,iFriend);
	return result;
}
public override bool IsUserInSource(ulong steamIDUser,ulong steamIDSource)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_IsUserInSource(m_SteamFriends,steamIDUser,steamIDSource);
	return result;
}
public override void SetInGameVoiceSpeaking(ulong steamIDUser,bool bSpeaking)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_SetInGameVoiceSpeaking(m_SteamFriends,steamIDUser,bSpeaking);
}
public override void ActivateGameOverlay(string pchDialog)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_ActivateGameOverlay(m_SteamFriends,pchDialog);
}
public override void ActivateGameOverlayToUser(string pchDialog,ulong steamID)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_ActivateGameOverlayToUser(m_SteamFriends,pchDialog,steamID);
}
public override void ActivateGameOverlayToWebPage(string pchURL)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_ActivateGameOverlayToWebPage(m_SteamFriends,pchURL);
}
public override void ActivateGameOverlayToStore(uint nAppID,char eFlag)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_ActivateGameOverlayToStore(m_SteamFriends,nAppID,eFlag);
}
public override void SetPlayedWith(ulong steamIDUserPlayedWith)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_SetPlayedWith(m_SteamFriends,steamIDUserPlayedWith);
}
public override void ActivateGameOverlayInviteDialog(ulong steamIDLobby)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_ActivateGameOverlayInviteDialog(m_SteamFriends,steamIDLobby);
}
public override int GetSmallFriendAvatar(ulong steamIDFriend)
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetSmallFriendAvatar(m_SteamFriends,steamIDFriend);
	return result;
}
public override int GetMediumFriendAvatar(ulong steamIDFriend)
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetMediumFriendAvatar(m_SteamFriends,steamIDFriend);
	return result;
}
public override int GetLargeFriendAvatar(ulong steamIDFriend)
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetLargeFriendAvatar(m_SteamFriends,steamIDFriend);
	return result;
}
public override bool RequestUserInformation(ulong steamIDUser,bool bRequireNameOnly)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_RequestUserInformation(m_SteamFriends,steamIDUser,bRequireNameOnly);
	return result;
}
public override ulong RequestClanOfficerList(ulong steamIDClan)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_RequestClanOfficerList(m_SteamFriends,steamIDClan);
	return result;
}
public override ulong GetClanOwner(ulong steamIDClan)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetClanOwner(m_SteamFriends,steamIDClan);
	return result;
}
public override int GetClanOfficerCount(ulong steamIDClan)
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetClanOfficerCount(m_SteamFriends,steamIDClan);
	return result;
}
public override ulong GetClanOfficerByIndex(ulong steamIDClan,int iOfficer)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetClanOfficerByIndex(m_SteamFriends,steamIDClan,iOfficer);
	return result;
}
public override uint GetUserRestrictions()
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetUserRestrictions(m_SteamFriends);
	return result;
}
public override bool SetRichPresence(string pchKey,string pchValue)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_SetRichPresence(m_SteamFriends,pchKey,pchValue);
	return result;
}
public override void ClearRichPresence()
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_ClearRichPresence(m_SteamFriends);
}
public override string GetFriendRichPresence(ulong steamIDFriend,string pchKey)
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetFriendRichPresence(m_SteamFriends,steamIDFriend,pchKey);
	return (string) Marshal.PtrToStructure(result, typeof(string));
}
public override int GetFriendRichPresenceKeyCount(ulong steamIDFriend)
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetFriendRichPresenceKeyCount(m_SteamFriends,steamIDFriend);
	return result;
}
public override string GetFriendRichPresenceKeyByIndex(ulong steamIDFriend,int iKey)
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetFriendRichPresenceKeyByIndex(m_SteamFriends,steamIDFriend,iKey);
	return (string) Marshal.PtrToStructure(result, typeof(string));
}
public override void RequestFriendRichPresence(ulong steamIDFriend)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_RequestFriendRichPresence(m_SteamFriends,steamIDFriend);
}
public override bool InviteUserToGame(ulong steamIDFriend,string pchConnectString)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_InviteUserToGame(m_SteamFriends,steamIDFriend,pchConnectString);
	return result;
}
public override int GetCoplayFriendCount()
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetCoplayFriendCount(m_SteamFriends);
	return result;
}
public override ulong GetCoplayFriend(int iCoplayFriend)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetCoplayFriend(m_SteamFriends,iCoplayFriend);
	return result;
}
public override int GetFriendCoplayTime(ulong steamIDFriend)
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetFriendCoplayTime(m_SteamFriends,steamIDFriend);
	return result;
}
public override uint GetFriendCoplayGame(ulong steamIDFriend)
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetFriendCoplayGame(m_SteamFriends,steamIDFriend);
	return result;
}
public override ulong JoinClanChatRoom(ulong steamIDClan)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_JoinClanChatRoom(m_SteamFriends,steamIDClan);
	return result;
}
public override bool LeaveClanChatRoom(ulong steamIDClan)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_LeaveClanChatRoom(m_SteamFriends,steamIDClan);
	return result;
}
public override int GetClanChatMemberCount(ulong steamIDClan)
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetClanChatMemberCount(m_SteamFriends,steamIDClan);
	return result;
}
public override ulong GetChatMemberByIndex(ulong steamIDClan,int iUser)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetChatMemberByIndex(m_SteamFriends,steamIDClan,iUser);
	return result;
}
public override bool SendClanChatMessage(ulong steamIDClanChat,string pchText)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_SendClanChatMessage(m_SteamFriends,steamIDClanChat,pchText);
	return result;
}
public override int GetClanChatMessage(ulong steamIDClanChat,int iMessage,IntPtr prgchText,int cchTextMax,ref uint peChatEntryType,out CSteamID psteamidChatter)
{
	...
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetClanChatMessage(m_SteamFriends,steamIDClanChat,iMessage,prgchText,cchTextMax,ref peChatEntryType,ref psteamidChatter);
	return result;
}
public override bool IsClanChatAdmin(ulong steamIDClanChat,ulong steamIDUser)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_IsClanChatAdmin(m_SteamFriends,steamIDClanChat,steamIDUser);
	return result;
}
public override bool IsClanChatWindowOpenInSteam(ulong steamIDClanChat)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_IsClanChatWindowOpenInSteam(m_SteamFriends,steamIDClanChat);
	return result;
}
public override bool OpenClanChatWindowInSteam(ulong steamIDClanChat)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_OpenClanChatWindowInSteam(m_SteamFriends,steamIDClanChat);
	return result;
}
public override bool CloseClanChatWindowInSteam(ulong steamIDClanChat)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_CloseClanChatWindowInSteam(m_SteamFriends,steamIDClanChat);
	return result;
}
public override bool SetListenForFriendsMessages(bool bInterceptEnabled)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_SetListenForFriendsMessages(m_SteamFriends,bInterceptEnabled);
	return result;
}
public override bool ReplyToFriendMessage(ulong steamIDFriend,string pchMsgToSend)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_ReplyToFriendMessage(m_SteamFriends,steamIDFriend,pchMsgToSend);
	return result;
}
public override int GetFriendMessage(ulong steamIDFriend,int iMessageID,IntPtr pvData,int cubData,ref uint peChatEntryType)
{
	CheckIfUsable();
	peChatEntryType = 0;
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetFriendMessage(m_SteamFriends,steamIDFriend,iMessageID,pvData,cubData,ref peChatEntryType);
	return result;
}
public override ulong GetFollowerCount(ulong steamID)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_GetFollowerCount(m_SteamFriends,steamID);
	return result;
}
public override ulong IsFollowing(ulong steamID)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_IsFollowing(m_SteamFriends,steamID);
	return result;
}
public override ulong EnumerateFollowingList(uint unStartIndex)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamFriends_EnumerateFollowingList(m_SteamFriends,unStartIndex);
	return result;
}
}
...
public override IntPtr GetIntPtr() { return m_SteamUtils; }

private void CheckIfUsable()
{
	if (m_SteamUtils == IntPtr.Zero)
	{
		throw new Exception("Steam Pointer not configured");
	}
}
...
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUtils_GetSecondsSinceAppActive(m_SteamUtils);
	return result;
}
public override uint GetSecondsSinceComputerActive()
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUtils_GetSecondsSinceComputerActive(m_SteamUtils);
	return result;
}
public override int GetConnectedUniverse()
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUtils_GetConnectedUniverse(m_SteamUtils);
	return result;
}
public override uint GetServerRealTime()
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUtils_GetServerRealTime(m_SteamUtils);
	return result;
}
public override string GetIPCountry()
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUtils_GetIPCountry(m_SteamUtils);
	return (string) Marshal.PtrToStructure(result, typeof(string));
}
public override bool GetImageSize(int iImage,ref uint pnWidth,ref uint pnHeight)
{
	...
	pnWidth = 0;
	pnHeight = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUtils_GetImageSize(m_SteamUtils,iImage,ref pnWidth,ref pnHeight);
	return result;
}
public override bool GetImageRGBA(int iImage,IntPtr pubDest,int nDestBufferSize)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUtils_GetImageRGBA(m_SteamUtils,iImage,pubDest,nDestBufferSize);
	return result;
}
public override bool GetCSERIPPort(ref uint unIP,ref char usPort)
{
	...
	unIP = 0;
	usPort = (char) 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUtils_GetCSERIPPort(m_SteamUtils,ref unIP,ref usPort);
	return result;
}
public override byte GetCurrentBatteryPower()
{
	CheckIfUsable();
	byte result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUtils_GetCurrentBatteryPower(m_SteamUtils);
	return result;
}
public override uint GetAppID()
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUtils_GetAppID(m_SteamUtils);
	return result;
}
public override void SetOverlayNotificationPosition(uint eNotificationPosition)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUtils_SetOverlayNotificationPosition(m_SteamUtils,eNotificationPosition);
}
public override bool IsAPICallCompleted(ulong hSteamAPICall,ref bool pbFailed)
{
	CheckIfUsable();
	pbFailed = false;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUtils_IsAPICallCompleted(m_SteamUtils,hSteamAPICall,ref pbFailed);
	return result;
}
public override int GetAPICallFailureReason(ulong hSteamAPICall)
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUtils_GetAPICallFailureReason(m_SteamUtils,hSteamAPICall);
	return result;
}
public override bool GetAPICallResult(ulong hSteamAPICall,IntPtr pCallback,int cubCallback,int iCallbackExpected,ref bool pbFailed)
{
	CheckIfUsable();
	pbFailed = false;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUtils_GetAPICallResult(m_SteamUtils,hSteamAPICall,pCallback,cubCallback,iCallbackExpected,ref pbFailed);
	return result;
}
public override void RunFrame()
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUtils_RunFrame(m_SteamUtils);
}
public override uint GetIPCCallCount()
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUtils_GetIPCCallCount(m_SteamUtils);
	return result;
}
public override void SetWarningMessageHook(IntPtr pFunction)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUtils_SetWarningMessageHook(m_SteamUtils,pFunction);
}
public override bool IsOverlayEnabled()
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUtils_IsOverlayEnabled(m_SteamUtils);
	return result;
}
public override bool BOverlayNeedsPresent()
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUtils_BOverlayNeedsPresent(m_SteamUtils);
	return result;
}
public override ulong CheckFileSignature(string szFileName)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUtils_CheckFileSignature(m_SteamUtils,szFileName);
	return result;
}
...
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUtils_ShowGamepadTextInput(m_SteamUtils,eInputMode,eLineInputMode,pchDescription,unCharMax,pchExistingText);
	return result;
}
public override uint GetEnteredGamepadTextLength()
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUtils_GetEnteredGamepadTextLength(m_SteamUtils);
	return result;
}
public override bool GetEnteredGamepadTextInput(string pchText,uint cchText)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUtils_GetEnteredGamepadTextInput(m_SteamUtils,pchText,cchText);
	return result;
}
public override string GetSteamUILanguage()
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUtils_GetSteamUILanguage(m_SteamUtils);
	return (string) Marshal.PtrToStructure(result, typeof(string));
}
public override bool IsSteamRunningInVR()
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUtils_IsSteamRunningInVR(m_SteamUtils);
	return result;
}
}
...
IntPtr m_SteamMatchmaking;

public override IntPtr GetIntPtr() { return m_SteamMatchmaking; }

private void CheckIfUsable()
{
	if (m_SteamMatchmaking == IntPtr.Zero)
	{
		throw new Exception("Steam Pointer not configured");
	}
}
...
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_GetFavoriteGameCount(m_SteamMatchmaking);
	return result;
}
public override bool GetFavoriteGame(int iGame,ref uint pnAppID,ref uint pnIP,ref char pnConnPort,ref char pnQueryPort,ref uint punFlags,ref uint pRTime32LastPlayedOnServer)
{
	...
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_GetFavoriteGame(m_SteamMatchmaking,iGame,ref pnAppID,ref pnIP,ref pnConnPort,ref pnQueryPort,ref punFlags,ref pRTime32LastPlayedOnServer);
	return result;
}
...
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_AddFavoriteGame(m_SteamMatchmaking,nAppID,nIP,nConnPort,nQueryPort,unFlags,rTime32LastPlayedOnServer);
	return result;
}
public override bool RemoveFavoriteGame(uint nAppID,uint nIP,char nConnPort,char nQueryPort,uint unFlags)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_RemoveFavoriteGame(m_SteamMatchmaking,nAppID,nIP,nConnPort,nQueryPort,unFlags);
	return result;
}
public override ulong RequestLobbyList()
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_RequestLobbyList(m_SteamMatchmaking);
	return result;
}
public override void AddRequestLobbyListStringFilter(string pchKeyToMatch,string pchValueToMatch,uint eComparisonType)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_AddRequestLobbyListStringFilter(m_SteamMatchmaking,pchKeyToMatch,pchValueToMatch,eComparisonType);
}
public override void AddRequestLobbyListNumericalFilter(string pchKeyToMatch,int nValueToMatch,uint eComparisonType)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_AddRequestLobbyListNumericalFilter(m_SteamMatchmaking,pchKeyToMatch,nValueToMatch,eComparisonType);
}
public override void AddRequestLobbyListNearValueFilter(string pchKeyToMatch,int nValueToBeCloseTo)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_AddRequestLobbyListNearValueFilter(m_SteamMatchmaking,pchKeyToMatch,nValueToBeCloseTo);
}
public override void AddRequestLobbyListFilterSlotsAvailable(int nSlotsAvailable)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_AddRequestLobbyListFilterSlotsAvailable(m_SteamMatchmaking,nSlotsAvailable);
}
public override void AddRequestLobbyListDistanceFilter(uint eLobbyDistanceFilter)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_AddRequestLobbyListDistanceFilter(m_SteamMatchmaking,eLobbyDistanceFilter);
}
public override void AddRequestLobbyListResultCountFilter(int cMaxResults)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_AddRequestLobbyListResultCountFilter(m_SteamMatchmaking,cMaxResults);
}
public override void AddRequestLobbyListCompatibleMembersFilter(ulong steamIDLobby)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_AddRequestLobbyListCompatibleMembersFilter(m_SteamMatchmaking,steamIDLobby);
}
public override ulong GetLobbyByIndex(int iLobby)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_GetLobbyByIndex(m_SteamMatchmaking,iLobby);
	return result;
}
public override ulong CreateLobby(uint eLobbyType,int cMaxMembers)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_CreateLobby(m_SteamMatchmaking,eLobbyType,cMaxMembers);
	return result;
}
public override ulong JoinLobby(ulong steamIDLobby)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_JoinLobby(m_SteamMatchmaking,steamIDLobby);
	return result;
}
public override void LeaveLobby(ulong steamIDLobby)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_LeaveLobby(m_SteamMatchmaking,steamIDLobby);
}
public override bool InviteUserToLobby(ulong steamIDLobby,ulong steamIDInvitee)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_InviteUserToLobby(m_SteamMatchmaking,steamIDLobby,steamIDInvitee);
	return result;
}
public override int GetNumLobbyMembers(ulong steamIDLobby)
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_GetNumLobbyMembers(m_SteamMatchmaking,steamIDLobby);
	return result;
}
public override ulong GetLobbyMemberByIndex(ulong steamIDLobby,int iMember)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_GetLobbyMemberByIndex(m_SteamMatchmaking,steamIDLobby,iMember);
	return result;
}
public override string GetLobbyData(ulong steamIDLobby,string pchKey)
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_GetLobbyData(m_SteamMatchmaking,steamIDLobby,pchKey);
	return (string) Marshal.PtrToStructure(result, typeof(string));
}
public override bool SetLobbyData(ulong steamIDLobby,string pchKey,string pchValue)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_SetLobbyData(m_SteamMatchmaking,steamIDLobby,pchKey,pchValue);
	return result;
}
public override int GetLobbyDataCount(ulong steamIDLobby)
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_GetLobbyDataCount(m_SteamMatchmaking,steamIDLobby);
	return result;
}
...
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_GetLobbyDataByIndex(m_SteamMatchmaking,steamIDLobby,iLobbyData,pchKey,cchKeyBufferSize,pchValue,cchValueBufferSize);
	return result;
}
public override bool DeleteLobbyData(ulong steamIDLobby,string pchKey)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_DeleteLobbyData(m_SteamMatchmaking,steamIDLobby,pchKey);
	return result;
}
public override string GetLobbyMemberData(ulong steamIDLobby,ulong steamIDUser,string pchKey)
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_GetLobbyMemberData(m_SteamMatchmaking,steamIDLobby,steamIDUser,pchKey);
	return (string) Marshal.PtrToStructure(result, typeof(string));
}
public override void SetLobbyMemberData(ulong steamIDLobby,string pchKey,string pchValue)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_SetLobbyMemberData(m_SteamMatchmaking,steamIDLobby,pchKey,pchValue);
}
public override bool SendLobbyChatMsg(ulong steamIDLobby,IntPtr pvMsgBody,int cubMsgBody)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_SendLobbyChatMsg(m_SteamMatchmaking,steamIDLobby,pvMsgBody,cubMsgBody);
	return result;
}
public override int GetLobbyChatEntry(ulong steamIDLobby,int iChatID,out CSteamID pSteamIDUser,IntPtr pvData,int cubData,ref uint peChatEntryType)
{
	...
	peChatEntryType = 0;
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_GetLobbyChatEntry(m_SteamMatchmaking,steamIDLobby,iChatID,ref pSteamIDUser,pvData,cubData,ref peChatEntryType);
	return result;
}
public override bool RequestLobbyData(ulong steamIDLobby)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_RequestLobbyData(m_SteamMatchmaking,steamIDLobby);
	return result;
}
...
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_SetLobbyGameServer(m_SteamMatchmaking,steamIDLobby,unGameServerIP,unGameServerPort,steamIDGameServer);
}
public override bool GetLobbyGameServer(ulong steamIDLobby,ref uint punGameServerIP,ref char punGameServerPort,out CSteamID psteamIDGameServer)
{
	...
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_GetLobbyGameServer(m_SteamMatchmaking,steamIDLobby,ref punGameServerIP,ref punGameServerPort,ref psteamIDGameServer);
	return result;
}
public override bool SetLobbyMemberLimit(ulong steamIDLobby,int cMaxMembers)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_SetLobbyMemberLimit(m_SteamMatchmaking,steamIDLobby,cMaxMembers);
	return result;
}
public override int GetLobbyMemberLimit(ulong steamIDLobby)
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_GetLobbyMemberLimit(m_SteamMatchmaking,steamIDLobby);
	return result;
}
public override bool SetLobbyType(ulong steamIDLobby,uint eLobbyType)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_SetLobbyType(m_SteamMatchmaking,steamIDLobby,eLobbyType);
	return result;
}
public override bool SetLobbyJoinable(ulong steamIDLobby,bool bLobbyJoinable)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_SetLobbyJoinable(m_SteamMatchmaking,steamIDLobby,bLobbyJoinable);
	return result;
}
public override ulong GetLobbyOwner(ulong steamIDLobby)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_GetLobbyOwner(m_SteamMatchmaking,steamIDLobby);
	return result;
}
public override bool SetLobbyOwner(ulong steamIDLobby,ulong steamIDNewOwner)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_SetLobbyOwner(m_SteamMatchmaking,steamIDLobby,steamIDNewOwner);
	return result;
}
public override bool SetLinkedLobby(ulong steamIDLobby,ulong steamIDLobbyDependent)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmaking_SetLinkedLobby(m_SteamMatchmaking,steamIDLobby,steamIDLobbyDependent);
	return result;
}
}
...
IntPtr m_SteamMatchmakingServerListResponse;

public override IntPtr GetIntPtr() { return m_SteamMatchmakingServerListResponse; }

private void CheckIfUsable()
{
	if (m_SteamMatchmakingServerListResponse == IntPtr.Zero)
	{
		throw new Exception("Steam Pointer not configured");
	}
}
...
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmakingServerListResponse_ServerResponded(m_SteamMatchmakingServerListResponse,hRequest,iServer);
}
public override void ServerFailedToRespond(uint hRequest,int iServer)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmakingServerListResponse_ServerFailedToRespond(m_SteamMatchmakingServerListResponse,hRequest,iServer);
}
public override void RefreshComplete(uint hRequest,uint response)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmakingServerListResponse_RefreshComplete(m_SteamMatchmakingServerListResponse,hRequest,response);
}
}
...
IntPtr m_SteamMatchmakingPingResponse;

public override IntPtr GetIntPtr() { return m_SteamMatchmakingPingResponse; }

private void CheckIfUsable()
{
	if (m_SteamMatchmakingPingResponse == IntPtr.Zero)
	{
		throw new Exception("Steam Pointer not configured");
	}
}
...
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmakingPingResponse_ServerResponded(m_SteamMatchmakingPingResponse,server);
}
public override void ServerFailedToRespond()
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmakingPingResponse_ServerFailedToRespond(m_SteamMatchmakingPingResponse);
}
}
...
IntPtr m_SteamMatchmakingPlayersResponse;

public override IntPtr GetIntPtr() { return m_SteamMatchmakingPlayersResponse; }

private void CheckIfUsable()
{
	if (m_SteamMatchmakingPlayersResponse == IntPtr.Zero)
	{
		throw new Exception("Steam Pointer not configured");
	}
}
...
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmakingPlayersResponse_AddPlayerToList(m_SteamMatchmakingPlayersResponse,pchName,nScore,flTimePlayed);
}
public override void PlayersFailedToRespond()
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmakingPlayersResponse_PlayersFailedToRespond(m_SteamMatchmakingPlayersResponse);
}
public override void PlayersRefreshComplete()
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmakingPlayersResponse_PlayersRefreshComplete(m_SteamMatchmakingPlayersResponse);
}
}
...
IntPtr m_SteamMatchmakingRulesResponse;

public override IntPtr GetIntPtr() { return m_SteamMatchmakingRulesResponse; }

private void CheckIfUsable()
{
	if (m_SteamMatchmakingRulesResponse == IntPtr.Zero)
	{
		throw new Exception("Steam Pointer not configured");
	}
}
...
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmakingRulesResponse_RulesResponded(m_SteamMatchmakingRulesResponse,pchRule,pchValue);
}
public override void RulesFailedToRespond()
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmakingRulesResponse_RulesFailedToRespond(m_SteamMatchmakingRulesResponse);
}
public override void RulesRefreshComplete()
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmakingRulesResponse_RulesRefreshComplete(m_SteamMatchmakingRulesResponse);
}
}
...
IntPtr m_SteamMatchmakingServers;

public override IntPtr GetIntPtr() { return m_SteamMatchmakingServers; }

private void CheckIfUsable()
{
	if (m_SteamMatchmakingServers == IntPtr.Zero)
	{
		throw new Exception("Steam Pointer not configured");
	}
}
...
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmakingServers_RequestInternetServerList(m_SteamMatchmakingServers,iApp,ppchFilters,(uint) ppchFilters.Length,pRequestServersResponse.GetIntPtr());
	return result;
}
public override uint RequestLANServerList(uint iApp,ISteamMatchmakingServerListResponse pRequestServersResponse)
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmakingServers_RequestLANServerList(m_SteamMatchmakingServers,iApp,pRequestServersResponse.GetIntPtr());
	return result;
}
...
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmakingServers_RequestFriendsServerList(m_SteamMatchmakingServers,iApp,ppchFilters,(uint) ppchFilters.Length,pRequestServersResponse.GetIntPtr());
	return result;
}
...
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmakingServers_RequestFavoritesServerList(m_SteamMatchmakingServers,iApp,ppchFilters,(uint) ppchFilters.Length,pRequestServersResponse.GetIntPtr());
	return result;
}
...
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmakingServers_RequestHistoryServerList(m_SteamMatchmakingServers,iApp,ppchFilters,(uint) ppchFilters.Length,pRequestServersResponse.GetIntPtr());
	return result;
}
...
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmakingServers_RequestSpectatorServerList(m_SteamMatchmakingServers,iApp,ppchFilters,(uint) ppchFilters.Length,pRequestServersResponse.GetIntPtr());
	return result;
}
public override void ReleaseRequest(uint hServerListRequest)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmakingServers_ReleaseRequest(m_SteamMatchmakingServers,hServerListRequest);
}
public override gameserveritem_t GetServerDetails(uint hRequest,int iServer)
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmakingServers_GetServerDetails(m_SteamMatchmakingServers,hRequest,iServer);
...
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmakingServers_CancelQuery(m_SteamMatchmakingServers,hRequest);
}
public override void RefreshQuery(uint hRequest)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmakingServers_RefreshQuery(m_SteamMatchmakingServers,hRequest);
}
public override bool IsRefreshing(uint hRequest)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmakingServers_IsRefreshing(m_SteamMatchmakingServers,hRequest);
	return result;
}
public override int GetServerCount(uint hRequest)
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmakingServers_GetServerCount(m_SteamMatchmakingServers,hRequest);
	return result;
}
public override void RefreshServer(uint hRequest,int iServer)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmakingServers_RefreshServer(m_SteamMatchmakingServers,hRequest,iServer);
}
public override uint PingServer(uint unIP,char usPort,ISteamMatchmakingPingResponse pRequestServersResponse)
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmakingServers_PingServer(m_SteamMatchmakingServers,unIP,usPort,pRequestServersResponse.GetIntPtr());
	return result;
}
public override uint PlayerDetails(uint unIP,char usPort,ISteamMatchmakingPlayersResponse pRequestServersResponse)
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmakingServers_PlayerDetails(m_SteamMatchmakingServers,unIP,usPort,pRequestServersResponse.GetIntPtr());
	return result;
}
public override uint ServerRules(uint unIP,char usPort,ISteamMatchmakingRulesResponse pRequestServersResponse)
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmakingServers_ServerRules(m_SteamMatchmakingServers,unIP,usPort,pRequestServersResponse.GetIntPtr());
	return result;
}
public override void CancelServerQuery(uint hServerQuery)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMatchmakingServers_CancelServerQuery(m_SteamMatchmakingServers,hServerQuery);
}
}
...
IntPtr m_SteamRemoteStorage;

public override IntPtr GetIntPtr() { return m_SteamRemoteStorage; }

private void CheckIfUsable()
{
	if (m_SteamRemoteStorage == IntPtr.Zero)
	{
		throw new Exception("Steam Pointer not configured");
	}
}
...
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_FileWrite(m_SteamRemoteStorage,pchFile,pvData,cubData);
	return result;
}
public override int FileRead(string pchFile,IntPtr pvData,int cubDataToRead)
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_FileRead(m_SteamRemoteStorage,pchFile,pvData,cubDataToRead);
	return result;
}
public override bool FileForget(string pchFile)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_FileForget(m_SteamRemoteStorage,pchFile);
	return result;
}
public override bool FileDelete(string pchFile)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_FileDelete(m_SteamRemoteStorage,pchFile);
	return result;
}
public override ulong FileShare(string pchFile)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_FileShare(m_SteamRemoteStorage,pchFile);
	return result;
}
public override bool SetSyncPlatforms(string pchFile,uint eRemoteStoragePlatform)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_SetSyncPlatforms(m_SteamRemoteStorage,pchFile,eRemoteStoragePlatform);
	return result;
}
public override ulong FileWriteStreamOpen(string pchFile)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_FileWriteStreamOpen(m_SteamRemoteStorage,pchFile);
	return result;
}
public override bool FileWriteStreamWriteChunk(ulong writeHandle,IntPtr pvData,int cubData)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_FileWriteStreamWriteChunk(m_SteamRemoteStorage,writeHandle,pvData,cubData);
	return result;
}
public override bool FileWriteStreamClose(ulong writeHandle)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_FileWriteStreamClose(m_SteamRemoteStorage,writeHandle);
	return result;
}
public override bool FileWriteStreamCancel(ulong writeHandle)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_FileWriteStreamCancel(m_SteamRemoteStorage,writeHandle);
	return result;
}
public override bool FileExists(string pchFile)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_FileExists(m_SteamRemoteStorage,pchFile);
	return result;
}
public override bool FilePersisted(string pchFile)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_FilePersisted(m_SteamRemoteStorage,pchFile);
	return result;
}
public override int GetFileSize(string pchFile)
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_GetFileSize(m_SteamRemoteStorage,pchFile);
	return result;
}
public override long GetFileTimestamp(string pchFile)
{
	CheckIfUsable();
	long result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_GetFileTimestamp(m_SteamRemoteStorage,pchFile);
	return result;
}
public override uint GetSyncPlatforms(string pchFile)
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_GetSyncPlatforms(m_SteamRemoteStorage,pchFile);
	return result;
}
public override int GetFileCount()
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_GetFileCount(m_SteamRemoteStorage);
	return result;
}
public override string GetFileNameAndSize(int iFile,ref int pnFileSizeInBytes)
{
	CheckIfUsable();
	pnFileSizeInBytes = 0;
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_GetFileNameAndSize(m_SteamRemoteStorage,iFile,ref pnFileSizeInBytes);
	return (string) Marshal.PtrToStructure(result, typeof(string));
}
public override bool GetQuota(ref int pnTotalBytes,ref int puAvailableBytes)
{
	...
	pnTotalBytes = 0;
	puAvailableBytes = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_GetQuota(m_SteamRemoteStorage,ref pnTotalBytes,ref puAvailableBytes);
	return result;
}
public override bool IsCloudEnabledForAccount()
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_IsCloudEnabledForAccount(m_SteamRemoteStorage);
	return result;
}
public override bool IsCloudEnabledForApp()
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_IsCloudEnabledForApp(m_SteamRemoteStorage);
	return result;
}
public override void SetCloudEnabledForApp(bool bEnabled)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_SetCloudEnabledForApp(m_SteamRemoteStorage,bEnabled);
}
public override ulong UGCDownload(ulong hContent,uint unPriority)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_UGCDownload(m_SteamRemoteStorage,hContent,unPriority);
	return result;
}
public override bool GetUGCDownloadProgress(ulong hContent,ref int pnBytesDownloaded,ref int pnBytesExpected)
{
	...
	pnBytesDownloaded = 0;
	pnBytesExpected = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_GetUGCDownloadProgress(m_SteamRemoteStorage,hContent,ref pnBytesDownloaded,ref pnBytesExpected);
	return result;
}
public override bool GetUGCDetails(ulong hContent,ref uint pnAppID,string ppchName,ref int pnFileSizeInBytes,out CSteamID pSteamIDOwner)
{
	...
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_GetUGCDetails(m_SteamRemoteStorage,hContent,ref pnAppID,ppchName,ref pnFileSizeInBytes,ref pSteamIDOwner);
	return result;
}
public override int UGCRead(ulong hContent,IntPtr pvData,int cubDataToRead,uint cOffset,uint eAction)
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_UGCRead(m_SteamRemoteStorage,hContent,pvData,cubDataToRead,cOffset,eAction);
	return result;
}
public override int GetCachedUGCCount()
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_GetCachedUGCCount(m_SteamRemoteStorage);
	return result;
}
public override ulong GetCachedUGCHandle(int iCachedContent)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_GetCachedUGCHandle(m_SteamRemoteStorage,iCachedContent);
	return result;
}
...
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_PublishWorkshopFile(m_SteamRemoteStorage,pchFile,pchPreviewFile,nConsumerAppId,pchTitle,pchDescription,eVisibility,ref pTags,eWorkshopFileType);
	return result;
}
public override ulong CreatePublishedFileUpdateRequest(ulong unPublishedFileId)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_CreatePublishedFileUpdateRequest(m_SteamRemoteStorage,unPublishedFileId);
	return result;
}
public override bool UpdatePublishedFileFile(ulong updateHandle,string pchFile)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_UpdatePublishedFileFile(m_SteamRemoteStorage,updateHandle,pchFile);
	return result;
}
public override bool UpdatePublishedFilePreviewFile(ulong updateHandle,string pchPreviewFile)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_UpdatePublishedFilePreviewFile(m_SteamRemoteStorage,updateHandle,pchPreviewFile);
	return result;
}
public override bool UpdatePublishedFileTitle(ulong updateHandle,string pchTitle)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_UpdatePublishedFileTitle(m_SteamRemoteStorage,updateHandle,pchTitle);
	return result;
}
public override bool UpdatePublishedFileDescription(ulong updateHandle,string pchDescription)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_UpdatePublishedFileDescription(m_SteamRemoteStorage,updateHandle,pchDescription);
	return result;
}
public override bool UpdatePublishedFileVisibility(ulong updateHandle,uint eVisibility)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_UpdatePublishedFileVisibility(m_SteamRemoteStorage,updateHandle,eVisibility);
	return result;
}
public override bool UpdatePublishedFileTags(ulong updateHandle,ref SteamParamStringArray_t pTags)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_UpdatePublishedFileTags(m_SteamRemoteStorage,updateHandle,ref pTags);
	return result;
}
public override ulong CommitPublishedFileUpdate(ulong updateHandle)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_CommitPublishedFileUpdate(m_SteamRemoteStorage,updateHandle);
	return result;
}
public override ulong GetPublishedFileDetails(ulong unPublishedFileId,uint unMaxSecondsOld)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_GetPublishedFileDetails(m_SteamRemoteStorage,unPublishedFileId,unMaxSecondsOld);
	return result;
}
public override ulong DeletePublishedFile(ulong unPublishedFileId)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_DeletePublishedFile(m_SteamRemoteStorage,unPublishedFileId);
	return result;
}
public override ulong EnumerateUserPublishedFiles(uint unStartIndex)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_EnumerateUserPublishedFiles(m_SteamRemoteStorage,unStartIndex);
	return result;
}
public override ulong SubscribePublishedFile(ulong unPublishedFileId)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_SubscribePublishedFile(m_SteamRemoteStorage,unPublishedFileId);
	return result;
}
public override ulong EnumerateUserSubscribedFiles(uint unStartIndex)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_EnumerateUserSubscribedFiles(m_SteamRemoteStorage,unStartIndex);
	return result;
}
public override ulong UnsubscribePublishedFile(ulong unPublishedFileId)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_UnsubscribePublishedFile(m_SteamRemoteStorage,unPublishedFileId);
	return result;
}
public override bool UpdatePublishedFileSetChangeDescription(ulong updateHandle,string pchChangeDescription)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_UpdatePublishedFileSetChangeDescription(m_SteamRemoteStorage,updateHandle,pchChangeDescription);
	return result;
}
public override ulong GetPublishedItemVoteDetails(ulong unPublishedFileId)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_GetPublishedItemVoteDetails(m_SteamRemoteStorage,unPublishedFileId);
	return result;
}
public override ulong UpdateUserPublishedItemVote(ulong unPublishedFileId,bool bVoteUp)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_UpdateUserPublishedItemVote(m_SteamRemoteStorage,unPublishedFileId,bVoteUp);
	return result;
}
public override ulong GetUserPublishedItemVoteDetails(ulong unPublishedFileId)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_GetUserPublishedItemVoteDetails(m_SteamRemoteStorage,unPublishedFileId);
	return result;
}
...
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_EnumerateUserSharedWorkshopFiles(m_SteamRemoteStorage,steamId,unStartIndex,ref pRequiredTags,ref pExcludedTags);
	return result;
}
...
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_PublishVideo(m_SteamRemoteStorage,eVideoProvider,pchVideoAccount,pchVideoIdentifier,pchPreviewFile,nConsumerAppId,pchTitle,pchDescription,eVisibility,ref pTags);
	return result;
}
public override ulong SetUserPublishedFileAction(ulong unPublishedFileId,uint eAction)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_SetUserPublishedFileAction(m_SteamRemoteStorage,unPublishedFileId,eAction);
	return result;
}
public override ulong EnumeratePublishedFilesByUserAction(uint eAction,uint unStartIndex)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_EnumeratePublishedFilesByUserAction(m_SteamRemoteStorage,eAction,unStartIndex);
	return result;
}
...
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_EnumeratePublishedWorkshopFiles(m_SteamRemoteStorage,eEnumerationType,unStartIndex,unCount,unDays,ref pTags,ref pUserTags);
	return result;
}
public override ulong UGCDownloadToLocation(ulong hContent,string pchLocation,uint unPriority)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamRemoteStorage_UGCDownloadToLocation(m_SteamRemoteStorage,hContent,pchLocation,unPriority);
	return result;
}
}
...
IntPtr m_SteamUserStats;

public override IntPtr GetIntPtr() { return m_SteamUserStats; }

private void CheckIfUsable()
{
	if (m_SteamUserStats == IntPtr.Zero)
	{
		throw new Exception("Steam Pointer not configured");
	}
}
...
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_RequestCurrentStats(m_SteamUserStats);
	return result;
}
public override bool GetStat(string pchName,ref int pData)
{
	CheckIfUsable();
	pData = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_GetStat(m_SteamUserStats,pchName,ref pData);
	return result;
}
public override bool GetStat0(string pchName,ref float pData)
{
	CheckIfUsable();
	pData = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_GetStat0(m_SteamUserStats,pchName,ref pData);
	return result;
}
public override bool SetStat(string pchName,int nData)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_SetStat(m_SteamUserStats,pchName,nData);
	return result;
}
public override bool SetStat0(string pchName,float fData)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_SetStat0(m_SteamUserStats,pchName,fData);
	return result;
}
public override bool UpdateAvgRateStat(string pchName,float flCountThisSession,double dSessionLength)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_UpdateAvgRateStat(m_SteamUserStats,pchName,flCountThisSession,dSessionLength);
	return result;
}
public override bool GetAchievement(string pchName,ref bool pbAchieved)
{
	CheckIfUsable();
	pbAchieved = false;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_GetAchievement(m_SteamUserStats,pchName,ref pbAchieved);
	return result;
}
public override bool SetAchievement(string pchName)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_SetAchievement(m_SteamUserStats,pchName);
	return result;
}
public override bool ClearAchievement(string pchName)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_ClearAchievement(m_SteamUserStats,pchName);
	return result;
}
public override bool GetAchievementAndUnlockTime(string pchName,ref bool pbAchieved,ref uint punUnlockTime)
{
	...
	pbAchieved = false;
	punUnlockTime = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_GetAchievementAndUnlockTime(m_SteamUserStats,pchName,ref pbAchieved,ref punUnlockTime);
	return result;
}
public override bool StoreStats()
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_StoreStats(m_SteamUserStats);
	return result;
}
public override int GetAchievementIcon(string pchName)
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_GetAchievementIcon(m_SteamUserStats,pchName);
	return result;
}
public override string GetAchievementDisplayAttribute(string pchName,string pchKey)
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_GetAchievementDisplayAttribute(m_SteamUserStats,pchName,pchKey);
	return (string) Marshal.PtrToStructure(result, typeof(string));
}
public override bool IndicateAchievementProgress(string pchName,uint nCurProgress,uint nMaxProgress)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_IndicateAchievementProgress(m_SteamUserStats,pchName,nCurProgress,nMaxProgress);
	return result;
}
public override uint GetNumAchievements()
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_GetNumAchievements(m_SteamUserStats);
	return result;
}
public override string GetAchievementName(uint iAchievement)
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_GetAchievementName(m_SteamUserStats,iAchievement);
	return (string) Marshal.PtrToStructure(result, typeof(string));
}
public override ulong RequestUserStats(ulong steamIDUser)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_RequestUserStats(m_SteamUserStats,steamIDUser);
	return result;
}
public override bool GetUserStat(ulong steamIDUser,string pchName,ref int pData)
{
	CheckIfUsable();
	pData = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_GetUserStat(m_SteamUserStats,steamIDUser,pchName,ref pData);
	return result;
}
public override bool GetUserStat0(ulong steamIDUser,string pchName,ref float pData)
{
	CheckIfUsable();
	pData = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_GetUserStat0(m_SteamUserStats,steamIDUser,pchName,ref pData);
	return result;
}
public override bool GetUserAchievement(ulong steamIDUser,string pchName,ref bool pbAchieved)
{
	CheckIfUsable();
	pbAchieved = false;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_GetUserAchievement(m_SteamUserStats,steamIDUser,pchName,ref pbAchieved);
	return result;
}
public override bool GetUserAchievementAndUnlockTime(ulong steamIDUser,string pchName,ref bool pbAchieved,ref uint punUnlockTime)
{
	...
	pbAchieved = false;
	punUnlockTime = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_GetUserAchievementAndUnlockTime(m_SteamUserStats,steamIDUser,pchName,ref pbAchieved,ref punUnlockTime);
	return result;
}
public override bool ResetAllStats(bool bAchievementsToo)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_ResetAllStats(m_SteamUserStats,bAchievementsToo);
	return result;
}
...
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_FindOrCreateLeaderboard(m_SteamUserStats,pchLeaderboardName,eLeaderboardSortMethod,eLeaderboardDisplayType);
	return result;
}
public override ulong FindLeaderboard(string pchLeaderboardName)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_FindLeaderboard(m_SteamUserStats,pchLeaderboardName);
	return result;
}
public override string GetLeaderboardName(ulong hSteamLeaderboard)
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_GetLeaderboardName(m_SteamUserStats,hSteamLeaderboard);
	return (string) Marshal.PtrToStructure(result, typeof(string));
}
public override int GetLeaderboardEntryCount(ulong hSteamLeaderboard)
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_GetLeaderboardEntryCount(m_SteamUserStats,hSteamLeaderboard);
	return result;
}
public override uint GetLeaderboardSortMethod(ulong hSteamLeaderboard)
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_GetLeaderboardSortMethod(m_SteamUserStats,hSteamLeaderboard);
	return result;
}
public override uint GetLeaderboardDisplayType(ulong hSteamLeaderboard)
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_GetLeaderboardDisplayType(m_SteamUserStats,hSteamLeaderboard);
	return result;
}
...
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_DownloadLeaderboardEntries(m_SteamUserStats,hSteamLeaderboard,eLeaderboardDataRequest,nRangeStart,nRangeEnd);
	return result;
}
public override ulong DownloadLeaderboardEntriesForUsers(ulong hSteamLeaderboard,CSteamID [] prgUsers)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_DownloadLeaderboardEntriesForUsers(m_SteamUserStats,hSteamLeaderboard,prgUsers,(int) prgUsers.Length);
	return result;
}
public override bool GetDownloadedLeaderboardEntry(ulong hSteamLeaderboardEntries,int index,ref LeaderboardEntry_t pLeaderboardEntry,ref int pDetails,int cDetailsMax)
{
	CheckIfUsable();
	pDetails = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_GetDownloadedLeaderboardEntry(m_SteamUserStats,hSteamLeaderboardEntries,index,ref pLeaderboardEntry,ref pDetails,cDetailsMax);
	return result;
}
public override ulong UploadLeaderboardScore(ulong hSteamLeaderboard,uint eLeaderboardUploadScoreMethod,int nScore,ref int pScoreDetails,int cScoreDetailsCount)
{
	CheckIfUsable();
	pScoreDetails = 0;
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_UploadLeaderboardScore(m_SteamUserStats,hSteamLeaderboard,eLeaderboardUploadScoreMethod,nScore,ref pScoreDetails,cScoreDetailsCount);
	return result;
}
public override ulong AttachLeaderboardUGC(ulong hSteamLeaderboard,ulong hUGC)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_AttachLeaderboardUGC(m_SteamUserStats,hSteamLeaderboard,hUGC);
	return result;
}
public override ulong GetNumberOfCurrentPlayers()
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_GetNumberOfCurrentPlayers(m_SteamUserStats);
	return result;
}
public override ulong RequestGlobalAchievementPercentages()
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_RequestGlobalAchievementPercentages(m_SteamUserStats);
	return result;
}
public override int GetMostAchievedAchievementInfo(string pchName,uint unNameBufLen,ref float pflPercent,ref bool pbAchieved)
{
	...
	pflPercent = 0;
	pbAchieved = false;
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_GetMostAchievedAchievementInfo(m_SteamUserStats,pchName,unNameBufLen,ref pflPercent,ref pbAchieved);
	return result;
}
public override int GetNextMostAchievedAchievementInfo(int iIteratorPrevious,string pchName,uint unNameBufLen,ref float pflPercent,ref bool pbAchieved)
{
	...
	pflPercent = 0;
	pbAchieved = false;
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_GetNextMostAchievedAchievementInfo(m_SteamUserStats,iIteratorPrevious,pchName,unNameBufLen,ref pflPercent,ref pbAchieved);
	return result;
}
public override bool GetAchievementAchievedPercent(string pchName,ref float pflPercent)
{
	CheckIfUsable();
	pflPercent = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_GetAchievementAchievedPercent(m_SteamUserStats,pchName,ref pflPercent);
	return result;
}
public override ulong RequestGlobalStats(int nHistoryDays)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_RequestGlobalStats(m_SteamUserStats,nHistoryDays);
	return result;
}
public override bool GetGlobalStat(string pchStatName,ref long pData)
{
	CheckIfUsable();
	pData = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_GetGlobalStat(m_SteamUserStats,pchStatName,ref pData);
	return result;
}
public override bool GetGlobalStat0(string pchStatName,ref double pData)
{
	CheckIfUsable();
	pData = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_GetGlobalStat0(m_SteamUserStats,pchStatName,ref pData);
	return result;
}
public override int GetGlobalStatHistory(string pchStatName,long [] pData)
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_GetGlobalStatHistory(m_SteamUserStats,pchStatName,pData,(uint) pData.Length);
	return result;
}
public override int GetGlobalStatHistory0(string pchStatName,double [] pData)
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUserStats_GetGlobalStatHistory0(m_SteamUserStats,pchStatName,pData,(uint) pData.Length);
	return result;
}
}
...
public override IntPtr GetIntPtr() { return m_SteamApps; }

private void CheckIfUsable()
{
	if (m_SteamApps == IntPtr.Zero)
	{
		throw new Exception("Steam Pointer not configured");
	}
}
...
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamApps_BIsSubscribed(m_SteamApps);
	return result;
}
public override bool BIsLowViolence()
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamApps_BIsLowViolence(m_SteamApps);
	return result;
}
public override bool BIsCybercafe()
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamApps_BIsCybercafe(m_SteamApps);
	return result;
}
public override bool BIsVACBanned()
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamApps_BIsVACBanned(m_SteamApps);
	return result;
}
public override string GetCurrentGameLanguage()
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamApps_GetCurrentGameLanguage(m_SteamApps);
	return (string) Marshal.PtrToStructure(result, typeof(string));
}
public override string GetAvailableGameLanguages()
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamApps_GetAvailableGameLanguages(m_SteamApps);
	return (string) Marshal.PtrToStructure(result, typeof(string));
}
public override bool BIsSubscribedApp(uint appID)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamApps_BIsSubscribedApp(m_SteamApps,appID);
	return result;
}
public override bool BIsDlcInstalled(uint appID)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamApps_BIsDlcInstalled(m_SteamApps,appID);
	return result;
}
public override uint GetEarliestPurchaseUnixTime(uint nAppID)
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamApps_GetEarliestPurchaseUnixTime(m_SteamApps,nAppID);
	return result;
}
public override bool BIsSubscribedFromFreeWeekend()
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamApps_BIsSubscribedFromFreeWeekend(m_SteamApps);
	return result;
}
public override int GetDLCCount()
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamApps_GetDLCCount(m_SteamApps);
	return result;
}
public override bool BGetDLCDataByIndex(int iDLC,ref uint pAppID,ref bool pbAvailable,string pchName,int cchNameBufferSize)
{
	...
	pAppID = 0;
	pbAvailable = false;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamApps_BGetDLCDataByIndex(m_SteamApps,iDLC,ref pAppID,ref pbAvailable,pchName,cchNameBufferSize);
	return result;
}
public override void InstallDLC(uint nAppID)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamApps_InstallDLC(m_SteamApps,nAppID);
}
public override void UninstallDLC(uint nAppID)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamApps_UninstallDLC(m_SteamApps,nAppID);
}
public override void RequestAppProofOfPurchaseKey(uint nAppID)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamApps_RequestAppProofOfPurchaseKey(m_SteamApps,nAppID);
}
public override bool GetCurrentBetaName(string pchName,int cchNameBufferSize)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamApps_GetCurrentBetaName(m_SteamApps,pchName,cchNameBufferSize);
	return result;
}
public override bool MarkContentCorrupt(bool bMissingFilesOnly)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamApps_MarkContentCorrupt(m_SteamApps,bMissingFilesOnly);
	return result;
}
public override uint GetInstalledDepots(uint appID,ref uint pvecDepots,uint cMaxDepots)
{
	CheckIfUsable();
	pvecDepots = 0;
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamApps_GetInstalledDepots(m_SteamApps,appID,ref pvecDepots,cMaxDepots);
	return result;
}
public override uint GetAppInstallDir(uint appID,string pchFolder,uint cchFolderBufferSize)
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamApps_GetAppInstallDir(m_SteamApps,appID,pchFolder,cchFolderBufferSize);
	return result;
}
public override bool BIsAppInstalled(uint appID)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamApps_BIsAppInstalled(m_SteamApps,appID);
	return result;
}
public override ulong GetAppOwner()
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamApps_GetAppOwner(m_SteamApps);
	return result;
}
public override string GetLaunchQueryParam(string pchKey)
{
	CheckIfUsable();
	IntPtr result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamApps_GetLaunchQueryParam(m_SteamApps,pchKey);
	return (string) Marshal.PtrToStructure(result, typeof(string));
}
public override bool GetDlcDownloadProgress(uint nAppID,ref ulong punBytesDownloaded,ref ulong punBytesTotal)
{
	...
	punBytesTotal = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamApps_GetDlcDownloadProgress(m_SteamApps,nAppID,ref punBytesDownloaded,ref punBytesTotal);
	return result;
}
public override int GetAppBuildId()
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamApps_GetAppBuildId(m_SteamApps);
	return result;
}
}
...
IntPtr m_SteamNetworking;

public override IntPtr GetIntPtr() { return m_SteamNetworking; }

private void CheckIfUsable()
{
	if (m_SteamNetworking == IntPtr.Zero)
	{
		throw new Exception("Steam Pointer not configured");
	}
}
...
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamNetworking_SendP2PPacket(m_SteamNetworking,steamIDRemote,pubData,cubData,eP2PSendType,nChannel);
	return result;
}
public override bool IsP2PPacketAvailable(ref uint pcubMsgSize,int nChannel)
{
	CheckIfUsable();
	pcubMsgSize = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamNetworking_IsP2PPacketAvailable(m_SteamNetworking,ref pcubMsgSize,nChannel);
	return result;
}
public override bool ReadP2PPacket(IntPtr pubDest,uint cubDest,ref uint pcubMsgSize,ref CSteamID psteamIDRemote,int nChannel)
{
	CheckIfUsable();
	pcubMsgSize = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamNetworking_ReadP2PPacket(m_SteamNetworking,pubDest,cubDest,ref pcubMsgSize,ref psteamIDRemote,nChannel);
	return result;
}
public override bool AcceptP2PSessionWithUser(ulong steamIDRemote)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamNetworking_AcceptP2PSessionWithUser(m_SteamNetworking,steamIDRemote);
	return result;
}
public override bool CloseP2PSessionWithUser(ulong steamIDRemote)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamNetworking_CloseP2PSessionWithUser(m_SteamNetworking,steamIDRemote);
	return result;
}
public override bool CloseP2PChannelWithUser(ulong steamIDRemote,int nChannel)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamNetworking_CloseP2PChannelWithUser(m_SteamNetworking,steamIDRemote,nChannel);
	return result;
}
public override bool GetP2PSessionState(ulong steamIDRemote,ref P2PSessionState_t pConnectionState)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamNetworking_GetP2PSessionState(m_SteamNetworking,steamIDRemote,ref pConnectionState);
	return result;
}
public override bool AllowP2PPacketRelay(bool bAllow)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamNetworking_AllowP2PPacketRelay(m_SteamNetworking,bAllow);
	return result;
}
public override uint CreateListenSocket(int nVirtualP2PPort,uint nIP,char nPort,bool bAllowUseOfPacketRelay)
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamNetworking_CreateListenSocket(m_SteamNetworking,nVirtualP2PPort,nIP,nPort,bAllowUseOfPacketRelay);
	return result;
}
...
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamNetworking_CreateP2PConnectionSocket(m_SteamNetworking,steamIDTarget,nVirtualPort,nTimeoutSec,bAllowUseOfPacketRelay);
	return result;
}
public override uint CreateConnectionSocket(uint nIP,char nPort,int nTimeoutSec)
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamNetworking_CreateConnectionSocket(m_SteamNetworking,nIP,nPort,nTimeoutSec);
	return result;
}
public override bool DestroySocket(uint hSocket,bool bNotifyRemoteEnd)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamNetworking_DestroySocket(m_SteamNetworking,hSocket,bNotifyRemoteEnd);
	return result;
}
public override bool DestroyListenSocket(uint hSocket,bool bNotifyRemoteEnd)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamNetworking_DestroyListenSocket(m_SteamNetworking,hSocket,bNotifyRemoteEnd);
	return result;
}
public override bool SendDataOnSocket(uint hSocket,IntPtr pubData,uint cubData,bool bReliable)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamNetworking_SendDataOnSocket(m_SteamNetworking,hSocket,pubData,cubData,bReliable);
	return result;
}
public override bool IsDataAvailableOnSocket(uint hSocket,ref uint pcubMsgSize)
{
	CheckIfUsable();
	pcubMsgSize = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamNetworking_IsDataAvailableOnSocket(m_SteamNetworking,hSocket,ref pcubMsgSize);
	return result;
}
public override bool RetrieveDataFromSocket(uint hSocket,IntPtr pubDest,uint cubDest,ref uint pcubMsgSize)
{
	CheckIfUsable();
	pcubMsgSize = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamNetworking_RetrieveDataFromSocket(m_SteamNetworking,hSocket,pubDest,cubDest,ref pcubMsgSize);
	return result;
}
public override bool IsDataAvailable(uint hListenSocket,ref uint pcubMsgSize,ref uint phSocket)
{
	...
	pcubMsgSize = 0;
	phSocket = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamNetworking_IsDataAvailable(m_SteamNetworking,hListenSocket,ref pcubMsgSize,ref phSocket);
	return result;
}
public override bool RetrieveData(uint hListenSocket,IntPtr pubDest,uint cubDest,ref uint pcubMsgSize,ref uint phSocket)
{
	...
	pcubMsgSize = 0;
	phSocket = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamNetworking_RetrieveData(m_SteamNetworking,hListenSocket,pubDest,cubDest,ref pcubMsgSize,ref phSocket);
	return result;
}
public override bool GetSocketInfo(uint hSocket,ref CSteamID pSteamIDRemote,ref int peSocketStatus,ref uint punIPRemote,ref char punPortRemote)
{
	...
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamNetworking_GetSocketInfo(m_SteamNetworking,hSocket,ref pSteamIDRemote,ref peSocketStatus,ref punIPRemote,ref punPortRemote);
	return result;
}
public override bool GetListenSocketInfo(uint hListenSocket,ref uint pnIP,ref char pnPort)
{
	...
	pnIP = 0;
	pnPort = (char) 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamNetworking_GetListenSocketInfo(m_SteamNetworking,hListenSocket,ref pnIP,ref pnPort);
	return result;
}
public override uint GetSocketConnectionType(uint hSocket)
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamNetworking_GetSocketConnectionType(m_SteamNetworking,hSocket);
	return result;
}
public override int GetMaxPacketSize(uint hSocket)
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamNetworking_GetMaxPacketSize(m_SteamNetworking,hSocket);
	return result;
}
}
...
IntPtr m_SteamScreenshots;

public override IntPtr GetIntPtr() { return m_SteamScreenshots; }

private void CheckIfUsable()
{
	if (m_SteamScreenshots == IntPtr.Zero)
	{
		throw new Exception("Steam Pointer not configured");
	}
}
...
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamScreenshots_WriteScreenshot(m_SteamScreenshots,pubRGB,cubRGB,nWidth,nHeight);
	return result;
}
public override uint AddScreenshotToLibrary(string pchFilename,string pchThumbnailFilename,int nWidth,int nHeight)
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamScreenshots_AddScreenshotToLibrary(m_SteamScreenshots,pchFilename,pchThumbnailFilename,nWidth,nHeight);
	return result;
}
public override void TriggerScreenshot()
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamScreenshots_TriggerScreenshot(m_SteamScreenshots);
}
public override void HookScreenshots(bool bHook)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamScreenshots_HookScreenshots(m_SteamScreenshots,bHook);
}
public override bool SetLocation(uint hScreenshot,string pchLocation)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamScreenshots_SetLocation(m_SteamScreenshots,hScreenshot,pchLocation);
	return result;
}
public override bool TagUser(uint hScreenshot,ulong steamID)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamScreenshots_TagUser(m_SteamScreenshots,hScreenshot,steamID);
	return result;
}
public override bool TagPublishedFile(uint hScreenshot,ulong unPublishedFileID)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamScreenshots_TagPublishedFile(m_SteamScreenshots,hScreenshot,unPublishedFileID);
	return result;
}
}
...
public override IntPtr GetIntPtr() { return m_SteamMusic; }

private void CheckIfUsable()
{
	if (m_SteamMusic == IntPtr.Zero)
	{
		throw new Exception("Steam Pointer not configured");
	}
}
...
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusic_BIsEnabled(m_SteamMusic);
	return result;
}
public override bool BIsPlaying()
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusic_BIsPlaying(m_SteamMusic);
	return result;
}
public override int GetPlaybackStatus()
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusic_GetPlaybackStatus(m_SteamMusic);
	return result;
}
public override void Play()
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusic_Play(m_SteamMusic);
}
public override void Pause()
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusic_Pause(m_SteamMusic);
}
public override void PlayPrevious()
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusic_PlayPrevious(m_SteamMusic);
}
public override void PlayNext()
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusic_PlayNext(m_SteamMusic);
}
public override void SetVolume(float flVolume)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusic_SetVolume(m_SteamMusic,flVolume);
}
public override float GetVolume()
{
	CheckIfUsable();
	float result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusic_GetVolume(m_SteamMusic);
	return result;
}
}
...
IntPtr m_SteamMusicRemote;

public override IntPtr GetIntPtr() { return m_SteamMusicRemote; }

private void CheckIfUsable()
{
	if (m_SteamMusicRemote == IntPtr.Zero)
	{
		throw new Exception("Steam Pointer not configured");
	}
}
...
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusicRemote_RegisterSteamMusicRemote(m_SteamMusicRemote,pchName);
	return result;
}
public override bool DeregisterSteamMusicRemote()
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusicRemote_DeregisterSteamMusicRemote(m_SteamMusicRemote);
	return result;
}
public override bool BIsCurrentMusicRemote()
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusicRemote_BIsCurrentMusicRemote(m_SteamMusicRemote);
	return result;
}
public override bool BActivationSuccess(bool bValue)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusicRemote_BActivationSuccess(m_SteamMusicRemote,bValue);
	return result;
}
public override bool SetDisplayName(string pchDisplayName)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusicRemote_SetDisplayName(m_SteamMusicRemote,pchDisplayName);
	return result;
}
public override bool SetPNGIcon_64x64(IntPtr pvBuffer,uint cbBufferLength)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusicRemote_SetPNGIcon_64x64(m_SteamMusicRemote,pvBuffer,cbBufferLength);
	return result;
}
public override bool EnablePlayPrevious(bool bValue)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusicRemote_EnablePlayPrevious(m_SteamMusicRemote,bValue);
	return result;
}
public override bool EnablePlayNext(bool bValue)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusicRemote_EnablePlayNext(m_SteamMusicRemote,bValue);
	return result;
}
public override bool EnableShuffled(bool bValue)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusicRemote_EnableShuffled(m_SteamMusicRemote,bValue);
	return result;
}
public override bool EnableLooped(bool bValue)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusicRemote_EnableLooped(m_SteamMusicRemote,bValue);
	return result;
}
public override bool EnableQueue(bool bValue)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusicRemote_EnableQueue(m_SteamMusicRemote,bValue);
	return result;
}
public override bool EnablePlaylists(bool bValue)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusicRemote_EnablePlaylists(m_SteamMusicRemote,bValue);
	return result;
}
public override bool UpdatePlaybackStatus(int nStatus)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusicRemote_UpdatePlaybackStatus(m_SteamMusicRemote,nStatus);
	return result;
}
public override bool UpdateShuffled(bool bValue)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusicRemote_UpdateShuffled(m_SteamMusicRemote,bValue);
	return result;
}
public override bool UpdateLooped(bool bValue)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusicRemote_UpdateLooped(m_SteamMusicRemote,bValue);
	return result;
}
public override bool UpdateVolume(float flValue)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusicRemote_UpdateVolume(m_SteamMusicRemote,flValue);
	return result;
}
public override bool CurrentEntryWillChange()
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusicRemote_CurrentEntryWillChange(m_SteamMusicRemote);
	return result;
}
public override bool CurrentEntryIsAvailable(bool bAvailable)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusicRemote_CurrentEntryIsAvailable(m_SteamMusicRemote,bAvailable);
	return result;
}
public override bool UpdateCurrentEntryText(string pchText)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusicRemote_UpdateCurrentEntryText(m_SteamMusicRemote,pchText);
	return result;
}
public override bool UpdateCurrentEntryElapsedSeconds(int nValue)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusicRemote_UpdateCurrentEntryElapsedSeconds(m_SteamMusicRemote,nValue);
	return result;
}
public override bool UpdateCurrentEntryCoverArt(IntPtr pvBuffer,uint cbBufferLength)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusicRemote_UpdateCurrentEntryCoverArt(m_SteamMusicRemote,pvBuffer,cbBufferLength);
	return result;
}
public override bool CurrentEntryDidChange()
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusicRemote_CurrentEntryDidChange(m_SteamMusicRemote);
	return result;
}
public override bool QueueWillChange()
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusicRemote_QueueWillChange(m_SteamMusicRemote);
	return result;
}
public override bool ResetQueueEntries()
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusicRemote_ResetQueueEntries(m_SteamMusicRemote);
	return result;
}
public override bool SetQueueEntry(int nID,int nPosition,string pchEntryText)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusicRemote_SetQueueEntry(m_SteamMusicRemote,nID,nPosition,pchEntryText);
	return result;
}
public override bool SetCurrentQueueEntry(int nID)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusicRemote_SetCurrentQueueEntry(m_SteamMusicRemote,nID);
	return result;
}
public override bool QueueDidChange()
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusicRemote_QueueDidChange(m_SteamMusicRemote);
	return result;
}
public override bool PlaylistWillChange()
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusicRemote_PlaylistWillChange(m_SteamMusicRemote);
	return result;
}
public override bool ResetPlaylistEntries()
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusicRemote_ResetPlaylistEntries(m_SteamMusicRemote);
	return result;
}
public override bool SetPlaylistEntry(int nID,int nPosition,string pchEntryText)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusicRemote_SetPlaylistEntry(m_SteamMusicRemote,nID,nPosition,pchEntryText);
	return result;
}
public override bool SetCurrentPlaylistEntry(int nID)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusicRemote_SetCurrentPlaylistEntry(m_SteamMusicRemote,nID);
	return result;
}
public override bool PlaylistDidChange()
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamMusicRemote_PlaylistDidChange(m_SteamMusicRemote);
	return result;
}
}
...
public override IntPtr GetIntPtr() { return m_SteamHTTP; }

private void CheckIfUsable()
{
	if (m_SteamHTTP == IntPtr.Zero)
	{
		throw new Exception("Steam Pointer not configured");
	}
}
...
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTTP_CreateHTTPRequest(m_SteamHTTP,eHTTPRequestMethod,pchAbsoluteURL);
	return result;
}
public override bool SetHTTPRequestContextValue(uint hRequest,ulong ulContextValue)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTTP_SetHTTPRequestContextValue(m_SteamHTTP,hRequest,ulContextValue);
	return result;
}
public override bool SetHTTPRequestNetworkActivityTimeout(uint hRequest,uint unTimeoutSeconds)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTTP_SetHTTPRequestNetworkActivityTimeout(m_SteamHTTP,hRequest,unTimeoutSeconds);
	return result;
}
public override bool SetHTTPRequestHeaderValue(uint hRequest,string pchHeaderName,string pchHeaderValue)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTTP_SetHTTPRequestHeaderValue(m_SteamHTTP,hRequest,pchHeaderName,pchHeaderValue);
	return result;
}
public override bool SetHTTPRequestGetOrPostParameter(uint hRequest,string pchParamName,string pchParamValue)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTTP_SetHTTPRequestGetOrPostParameter(m_SteamHTTP,hRequest,pchParamName,pchParamValue);
	return result;
}
public override bool SendHTTPRequest(uint hRequest,ref ulong pCallHandle)
{
	CheckIfUsable();
	pCallHandle = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTTP_SendHTTPRequest(m_SteamHTTP,hRequest,ref pCallHandle);
	return result;
}
public override bool SendHTTPRequestAndStreamResponse(uint hRequest,ref ulong pCallHandle)
{
	CheckIfUsable();
	pCallHandle = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTTP_SendHTTPRequestAndStreamResponse(m_SteamHTTP,hRequest,ref pCallHandle);
	return result;
}
public override bool DeferHTTPRequest(uint hRequest)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTTP_DeferHTTPRequest(m_SteamHTTP,hRequest);
	return result;
}
public override bool PrioritizeHTTPRequest(uint hRequest)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTTP_PrioritizeHTTPRequest(m_SteamHTTP,hRequest);
	return result;
}
public override bool GetHTTPResponseHeaderSize(uint hRequest,string pchHeaderName,ref uint unResponseHeaderSize)
{
	...
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTTP_GetHTTPResponseHeaderSize(m_SteamHTTP,hRequest,pchHeaderName,ref unResponseHeaderSize);
	return result;
}
...
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTTP_GetHTTPResponseHeaderValue(m_SteamHTTP,hRequest,pchHeaderName,pHeaderValueBuffer,unBufferSize);
	return result;
}
public override bool GetHTTPResponseBodySize(uint hRequest,ref uint unBodySize)
{
	CheckIfUsable();
	unBodySize = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTTP_GetHTTPResponseBodySize(m_SteamHTTP,hRequest,ref unBodySize);
	return result;
}
public override bool GetHTTPResponseBodyData(uint hRequest,IntPtr pBodyDataBuffer,uint unBufferSize)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTTP_GetHTTPResponseBodyData(m_SteamHTTP,hRequest,pBodyDataBuffer,unBufferSize);
	return result;
}
...
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTTP_GetHTTPStreamingResponseBodyData(m_SteamHTTP,hRequest,cOffset,pBodyDataBuffer,unBufferSize);
	return result;
}
public override bool ReleaseHTTPRequest(uint hRequest)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTTP_ReleaseHTTPRequest(m_SteamHTTP,hRequest);
	return result;
}
public override bool GetHTTPDownloadProgressPct(uint hRequest,ref float pflPercentOut)
{
	CheckIfUsable();
	pflPercentOut = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTTP_GetHTTPDownloadProgressPct(m_SteamHTTP,hRequest,ref pflPercentOut);
	return result;
}
public override bool SetHTTPRequestRawPostBody(uint hRequest,string pchContentType,IntPtr pubBody,uint unBodyLen)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTTP_SetHTTPRequestRawPostBody(m_SteamHTTP,hRequest,pchContentType,pubBody,unBodyLen);
	return result;
}
public override uint CreateCookieContainer(bool bAllowResponsesToModify)
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTTP_CreateCookieContainer(m_SteamHTTP,bAllowResponsesToModify);
	return result;
}
public override bool ReleaseCookieContainer(uint hCookieContainer)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTTP_ReleaseCookieContainer(m_SteamHTTP,hCookieContainer);
	return result;
}
public override bool SetCookie(uint hCookieContainer,string pchHost,string pchUrl,string pchCookie)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTTP_SetCookie(m_SteamHTTP,hCookieContainer,pchHost,pchUrl,pchCookie);
	return result;
}
public override bool SetHTTPRequestCookieContainer(uint hRequest,uint hCookieContainer)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTTP_SetHTTPRequestCookieContainer(m_SteamHTTP,hRequest,hCookieContainer);
	return result;
}
public override bool SetHTTPRequestUserAgentInfo(uint hRequest,string pchUserAgentInfo)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTTP_SetHTTPRequestUserAgentInfo(m_SteamHTTP,hRequest,pchUserAgentInfo);
	return result;
}
public override bool SetHTTPRequestRequiresVerifiedCertificate(uint hRequest,bool bRequireVerifiedCertificate)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTTP_SetHTTPRequestRequiresVerifiedCertificate(m_SteamHTTP,hRequest,bRequireVerifiedCertificate);
	return result;
}
public override bool SetHTTPRequestAbsoluteTimeoutMS(uint hRequest,uint unMilliseconds)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTTP_SetHTTPRequestAbsoluteTimeoutMS(m_SteamHTTP,hRequest,unMilliseconds);
	return result;
}
public override bool GetHTTPRequestWasTimedOut(uint hRequest,ref bool pbWasTimedOut)
{
	CheckIfUsable();
	pbWasTimedOut = false;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTTP_GetHTTPRequestWasTimedOut(m_SteamHTTP,hRequest,ref pbWasTimedOut);
	return result;
}
}
...
IntPtr m_SteamUnifiedMessages;

public override IntPtr GetIntPtr() { return m_SteamUnifiedMessages; }

private void CheckIfUsable()
{
	if (m_SteamUnifiedMessages == IntPtr.Zero)
	{
		throw new Exception("Steam Pointer not configured");
	}
}
...
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUnifiedMessages_SendMethod(m_SteamUnifiedMessages,pchServiceMethod,pRequestBuffer,unRequestBufferSize,unContext);
	return result;
}
public override bool GetMethodResponseInfo(ulong hHandle,ref uint punResponseSize,ref uint peResult)
{
	...
	punResponseSize = 0;
	peResult = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUnifiedMessages_GetMethodResponseInfo(m_SteamUnifiedMessages,hHandle,ref punResponseSize,ref peResult);
	return result;
}
...
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUnifiedMessages_GetMethodResponseData(m_SteamUnifiedMessages,hHandle,pResponseBuffer,unResponseBufferSize,bAutoRelease);
	return result;
}
public override bool ReleaseMethod(ulong hHandle)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUnifiedMessages_ReleaseMethod(m_SteamUnifiedMessages,hHandle);
	return result;
}
...
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUnifiedMessages_SendNotification(m_SteamUnifiedMessages,pchServiceNotification,pNotificationBuffer,unNotificationBufferSize);
	return result;
}
}
...
IntPtr m_SteamController;

public override IntPtr GetIntPtr() { return m_SteamController; }

private void CheckIfUsable()
{
	if (m_SteamController == IntPtr.Zero)
	{
		throw new Exception("Steam Pointer not configured");
	}
}
...
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamController_Init(m_SteamController,pchAbsolutePathToControllerConfigVDF);
	return result;
}
public override bool Shutdown()
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamController_Shutdown(m_SteamController);
	return result;
}
public override void RunFrame()
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamController_RunFrame(m_SteamController);
}
public override bool GetControllerState(uint unControllerIndex,ref SteamControllerState_t pState)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamController_GetControllerState(m_SteamController,unControllerIndex,ref pState);
	return result;
}
public override void TriggerHapticPulse(uint unControllerIndex,uint eTargetPad,char usDurationMicroSec)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamController_TriggerHapticPulse(m_SteamController,unControllerIndex,eTargetPad,usDurationMicroSec);
}
public override void SetOverrideMode(string pchMode)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamController_SetOverrideMode(m_SteamController,pchMode);
}
}
...
public override IntPtr GetIntPtr() { return m_SteamUGC; }

private void CheckIfUsable()
{
	if (m_SteamUGC == IntPtr.Zero)
	{
		throw new Exception("Steam Pointer not configured");
	}
}
...
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUGC_CreateQueryUserUGCRequest(m_SteamUGC,unAccountID,eListType,eMatchingUGCType,eSortOrder,nCreatorAppID,nConsumerAppID,unPage);
	return result;
}
...
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUGC_CreateQueryAllUGCRequest(m_SteamUGC,eQueryType,eMatchingeMatchingUGCTypeFileType,nCreatorAppID,nConsumerAppID,unPage);
	return result;
}
public override ulong SendQueryUGCRequest(ulong handle)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUGC_SendQueryUGCRequest(m_SteamUGC,handle);
	return result;
}
public override bool GetQueryUGCResult(ulong handle,uint index,ref SteamUGCDetails_t pDetails)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUGC_GetQueryUGCResult(m_SteamUGC,handle,index,ref pDetails);
	return result;
}
public override bool ReleaseQueryUGCRequest(ulong handle)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUGC_ReleaseQueryUGCRequest(m_SteamUGC,handle);
	return result;
}
public override bool AddRequiredTag(ulong handle,string pTagName)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUGC_AddRequiredTag(m_SteamUGC,handle,pTagName);
	return result;
}
public override bool AddExcludedTag(ulong handle,string pTagName)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUGC_AddExcludedTag(m_SteamUGC,handle,pTagName);
	return result;
}
public override bool SetReturnLongDescription(ulong handle,bool bReturnLongDescription)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUGC_SetReturnLongDescription(m_SteamUGC,handle,bReturnLongDescription);
	return result;
}
public override bool SetReturnTotalOnly(ulong handle,bool bReturnTotalOnly)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUGC_SetReturnTotalOnly(m_SteamUGC,handle,bReturnTotalOnly);
	return result;
}
public override bool SetAllowCachedResponse(ulong handle,uint unMaxAgeSeconds)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUGC_SetAllowCachedResponse(m_SteamUGC,handle,unMaxAgeSeconds);
	return result;
}
public override bool SetCloudFileNameFilter(ulong handle,string pMatchCloudFileName)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUGC_SetCloudFileNameFilter(m_SteamUGC,handle,pMatchCloudFileName);
	return result;
}
public override bool SetMatchAnyTag(ulong handle,bool bMatchAnyTag)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUGC_SetMatchAnyTag(m_SteamUGC,handle,bMatchAnyTag);
	return result;
}
public override bool SetSearchText(ulong handle,string pSearchText)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUGC_SetSearchText(m_SteamUGC,handle,pSearchText);
	return result;
}
public override bool SetRankedByTrendDays(ulong handle,uint unDays)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUGC_SetRankedByTrendDays(m_SteamUGC,handle,unDays);
	return result;
}
public override ulong RequestUGCDetails(ulong nPublishedFileID,uint unMaxAgeSeconds)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUGC_RequestUGCDetails(m_SteamUGC,nPublishedFileID,unMaxAgeSeconds);
	return result;
}
public override ulong CreateItem(uint nConsumerAppId,uint eFileType)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUGC_CreateItem(m_SteamUGC,nConsumerAppId,eFileType);
	return result;
}
public override ulong StartItemUpdate(uint nConsumerAppId,ulong nPublishedFileID)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUGC_StartItemUpdate(m_SteamUGC,nConsumerAppId,nPublishedFileID);
	return result;
}
public override bool SetItemTitle(ulong handle,string pchTitle)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUGC_SetItemTitle(m_SteamUGC,handle,pchTitle);
	return result;
}
public override bool SetItemDescription(ulong handle,string pchDescription)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUGC_SetItemDescription(m_SteamUGC,handle,pchDescription);
	return result;
}
public override bool SetItemVisibility(ulong handle,uint eVisibility)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUGC_SetItemVisibility(m_SteamUGC,handle,eVisibility);
	return result;
}
public override bool SetItemTags(ulong updateHandle,ref SteamParamStringArray_t pTags)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUGC_SetItemTags(m_SteamUGC,updateHandle,ref pTags);
	return result;
}
public override bool SetItemContent(ulong handle,string pszContentFolder)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUGC_SetItemContent(m_SteamUGC,handle,pszContentFolder);
	return result;
}
public override bool SetItemPreview(ulong handle,string pszPreviewFile)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUGC_SetItemPreview(m_SteamUGC,handle,pszPreviewFile);
	return result;
}
public override ulong SubmitItemUpdate(ulong handle,string pchChangeNote)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUGC_SubmitItemUpdate(m_SteamUGC,handle,pchChangeNote);
	return result;
}
public override uint GetItemUpdateProgress(ulong handle,ref ulong punBytesProcessed,ref ulong punBytesTotal)
{
	...
	punBytesProcessed = 0;
	punBytesTotal = 0;
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUGC_GetItemUpdateProgress(m_SteamUGC,handle,ref punBytesProcessed,ref punBytesTotal);
	return result;
}
public override ulong SubscribeItem(ulong nPublishedFileID)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUGC_SubscribeItem(m_SteamUGC,nPublishedFileID);
	return result;
}
public override ulong UnsubscribeItem(ulong nPublishedFileID)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUGC_UnsubscribeItem(m_SteamUGC,nPublishedFileID);
	return result;
}
public override uint GetNumSubscribedItems()
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUGC_GetNumSubscribedItems(m_SteamUGC);
	return result;
}
public override uint GetSubscribedItems(ref ulong pvecPublishedFileID,uint cMaxEntries)
{
	...
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUGC_GetSubscribedItems(m_SteamUGC,ref pvecPublishedFileID,cMaxEntries);
	return result;
}
public override bool GetItemInstallInfo(ulong nPublishedFileID,ref ulong punSizeOnDisk,string pchFolder,uint cchFolderSize,ref bool pbLegacyItem)
{
	...
	punSizeOnDisk = 0;
	pbLegacyItem = false;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUGC_GetItemInstallInfo(m_SteamUGC,nPublishedFileID,ref punSizeOnDisk,pchFolder,cchFolderSize,ref pbLegacyItem);
	return result;
}
public override bool GetItemUpdateInfo(ulong nPublishedFileID,ref bool pbNeedsUpdate,ref bool pbIsDownloading,ref ulong punBytesDownloaded,ref ulong punBytesTotal)
{
	...
	punBytesDownloaded = 0;
	punBytesTotal = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamUGC_GetItemUpdateInfo(m_SteamUGC,nPublishedFileID,ref pbNeedsUpdate,ref pbIsDownloading,ref punBytesDownloaded,ref punBytesTotal);
	return result;
}
}
...
IntPtr m_SteamAppList;

public override IntPtr GetIntPtr() { return m_SteamAppList; }

private void CheckIfUsable()
{
	if (m_SteamAppList == IntPtr.Zero)
	{
		throw new Exception("Steam Pointer not configured");
	}
}
...
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamAppList_GetNumInstalledApps(m_SteamAppList);
	return result;
}
public override uint GetInstalledApps(ref uint pvecAppID,uint unMaxAppIDs)
{
	CheckIfUsable();
	pvecAppID = 0;
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamAppList_GetInstalledApps(m_SteamAppList,ref pvecAppID,unMaxAppIDs);
	return result;
}
public override int GetAppName(uint nAppID,string pchName,int cchNameMax)
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamAppList_GetAppName(m_SteamAppList,nAppID,pchName,cchNameMax);
	return result;
}
public override int GetAppInstallDir(uint nAppID,string pchDirectory,int cchNameMax)
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamAppList_GetAppInstallDir(m_SteamAppList,nAppID,pchDirectory,cchNameMax);
	return result;
}
public override int GetAppBuildId(uint nAppID)
{
	CheckIfUsable();
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamAppList_GetAppBuildId(m_SteamAppList,nAppID);
	return result;
}
}
...
IntPtr m_SteamHTMLSurface;

public override IntPtr GetIntPtr() { return m_SteamHTMLSurface; }

private void CheckIfUsable()
{
	if (m_SteamHTMLSurface == IntPtr.Zero)
	{
		throw new Exception("Steam Pointer not configured");
	}
}
...
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_DestructISteamHTMLSurface(m_SteamHTMLSurface);
}
public override bool Init()
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_Init(m_SteamHTMLSurface);
	return result;
}
public override bool Shutdown()
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_Shutdown(m_SteamHTMLSurface);
	return result;
}
public override ulong CreateBrowser(string pchUserAgent,string pchUserCSS)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_CreateBrowser(m_SteamHTMLSurface,pchUserAgent,pchUserCSS);
	return result;
}
public override void RemoveBrowser(uint unBrowserHandle)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_RemoveBrowser(m_SteamHTMLSurface,unBrowserHandle);
}
public override void LoadURL(uint unBrowserHandle,string pchURL,string pchPostData)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_LoadURL(m_SteamHTMLSurface,unBrowserHandle,pchURL,pchPostData);
}
public override void SetSize(uint unBrowserHandle,uint unWidth,uint unHeight)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_SetSize(m_SteamHTMLSurface,unBrowserHandle,unWidth,unHeight);
}
public override void StopLoad(uint unBrowserHandle)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_StopLoad(m_SteamHTMLSurface,unBrowserHandle);
}
public override void Reload(uint unBrowserHandle)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_Reload(m_SteamHTMLSurface,unBrowserHandle);
}
public override void GoBack(uint unBrowserHandle)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_GoBack(m_SteamHTMLSurface,unBrowserHandle);
}
public override void GoForward(uint unBrowserHandle)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_GoForward(m_SteamHTMLSurface,unBrowserHandle);
}
public override void AddHeader(uint unBrowserHandle,string pchKey,string pchValue)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_AddHeader(m_SteamHTMLSurface,unBrowserHandle,pchKey,pchValue);
}
public override void ExecuteJavascript(uint unBrowserHandle,string pchScript)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_ExecuteJavascript(m_SteamHTMLSurface,unBrowserHandle,pchScript);
}
public override void MouseUp(uint unBrowserHandle,uint eMouseButton)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_MouseUp(m_SteamHTMLSurface,unBrowserHandle,eMouseButton);
}
public override void MouseDown(uint unBrowserHandle,uint eMouseButton)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_MouseDown(m_SteamHTMLSurface,unBrowserHandle,eMouseButton);
}
public override void MouseDoubleClick(uint unBrowserHandle,uint eMouseButton)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_MouseDoubleClick(m_SteamHTMLSurface,unBrowserHandle,eMouseButton);
}
public override void MouseMove(uint unBrowserHandle,int x,int y)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_MouseMove(m_SteamHTMLSurface,unBrowserHandle,x,y);
}
public override void MouseWheel(uint unBrowserHandle,int nDelta)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_MouseWheel(m_SteamHTMLSurface,unBrowserHandle,nDelta);
}
public override void KeyDown(uint unBrowserHandle,uint nNativeKeyCode,uint eHTMLKeyModifiers)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_KeyDown(m_SteamHTMLSurface,unBrowserHandle,nNativeKeyCode,eHTMLKeyModifiers);
}
public override void KeyUp(uint unBrowserHandle,uint nNativeKeyCode,uint eHTMLKeyModifiers)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_KeyUp(m_SteamHTMLSurface,unBrowserHandle,nNativeKeyCode,eHTMLKeyModifiers);
}
public override void KeyChar(uint unBrowserHandle,uint cUnicodeChar,uint eHTMLKeyModifiers)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_KeyChar(m_SteamHTMLSurface,unBrowserHandle,cUnicodeChar,eHTMLKeyModifiers);
}
public override void SetHorizontalScroll(uint unBrowserHandle,uint nAbsolutePixelScroll)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_SetHorizontalScroll(m_SteamHTMLSurface,unBrowserHandle,nAbsolutePixelScroll);
}
public override void SetVerticalScroll(uint unBrowserHandle,uint nAbsolutePixelScroll)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_SetVerticalScroll(m_SteamHTMLSurface,unBrowserHandle,nAbsolutePixelScroll);
}
public override void SetKeyFocus(uint unBrowserHandle,bool bHasKeyFocus)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_SetKeyFocus(m_SteamHTMLSurface,unBrowserHandle,bHasKeyFocus);
}
public override void ViewSource(uint unBrowserHandle)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_ViewSource(m_SteamHTMLSurface,unBrowserHandle);
}
public override void CopyToClipboard(uint unBrowserHandle)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_CopyToClipboard(m_SteamHTMLSurface,unBrowserHandle);
}
public override void PasteFromClipboard(uint unBrowserHandle)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_PasteFromClipboard(m_SteamHTMLSurface,unBrowserHandle);
}
public override void Find(uint unBrowserHandle,string pchSearchStr,bool bCurrentlyInFind,bool bReverse)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_Find(m_SteamHTMLSurface,unBrowserHandle,pchSearchStr,bCurrentlyInFind,bReverse);
}
public override void StopFind(uint unBrowserHandle)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_StopFind(m_SteamHTMLSurface,unBrowserHandle);
}
public override void GetLinkAtPosition(uint unBrowserHandle,int x,int y)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_GetLinkAtPosition(m_SteamHTMLSurface,unBrowserHandle,x,y);
}
...
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_SetCookie(m_SteamHTMLSurface,pchHostname,pchKey,pchValue,pchPath,nExpires,bSecure,bHTTPOnly);
}
public override void SetPageScaleFactor(uint unBrowserHandle,float flZoom,int nPointX,int nPointY)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_SetPageScaleFactor(m_SteamHTMLSurface,unBrowserHandle,flZoom,nPointX,nPointY);
}
public override void AllowStartRequest(uint unBrowserHandle,bool bAllowed)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_AllowStartRequest(m_SteamHTMLSurface,unBrowserHandle,bAllowed);
}
public override void JSDialogResponse(uint unBrowserHandle,bool bResult)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_JSDialogResponse(m_SteamHTMLSurface,unBrowserHandle,bResult);
}
public override void FileLoadDialogResponse(uint unBrowserHandle,string pchSelectedFiles)
{
	CheckIfUsable();
	pchSelectedFiles = "";
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamHTMLSurface_FileLoadDialogResponse(m_SteamHTMLSurface,unBrowserHandle,pchSelectedFiles);
}
}
...
IntPtr m_SteamInventory;

public override IntPtr GetIntPtr() { return m_SteamInventory; }

private void CheckIfUsable()
{
	if (m_SteamInventory == IntPtr.Zero)
	{
		throw new Exception("Steam Pointer not configured");
	}
}
...
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamInventory_GetResultStatus(m_SteamInventory,resultHandle);
	return result;
}
public override bool GetResultItems(int resultHandle,out SteamItemDetails_t [] pOutItemsArray)
{
	...
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamInventory_GetResultItems(m_SteamInventory,resultHandle,null,ref punOutItemsArraySize);
	pOutItemsArray= new SteamItemDetails_t[punOutItemsArraySize];
	 result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamInventory_GetResultItems(m_SteamInventory,resultHandle,pOutItemsArray,ref punOutItemsArraySize);
	return result;
}
public override uint GetResultTimestamp(int resultHandle)
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamInventory_GetResultTimestamp(m_SteamInventory,resultHandle);
	return result;
}
public override bool CheckResultSteamID(int resultHandle,ulong steamIDExpected)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamInventory_CheckResultSteamID(m_SteamInventory,resultHandle,steamIDExpected);
	return result;
}
public override void DestroyResult(int resultHandle)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamInventory_DestroyResult(m_SteamInventory,resultHandle);
}
public override bool GetAllItems(ref int pResultHandle)
{
	CheckIfUsable();
	pResultHandle = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamInventory_GetAllItems(m_SteamInventory,ref pResultHandle);
	return result;
}
public override bool GetItemsByID(ref int pResultHandle,ulong [] pInstanceIDs)
{
	CheckIfUsable();
	pResultHandle = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamInventory_GetItemsByID(m_SteamInventory,ref pResultHandle,pInstanceIDs,(uint) pInstanceIDs.Length);
	return result;
}
public override bool SerializeResult(int resultHandle,IntPtr pOutBuffer,ref uint punOutBufferSize)
{
	CheckIfUsable();
	punOutBufferSize = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamInventory_SerializeResult(m_SteamInventory,resultHandle,pOutBuffer,ref punOutBufferSize);
	return result;
}
public override bool DeserializeResult(ref int pOutResultHandle,IntPtr pBuffer,uint unBufferSize,bool bRESERVED_MUST_BE_FALSE)
{
	CheckIfUsable();
	pOutResultHandle = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamInventory_DeserializeResult(m_SteamInventory,ref pOutResultHandle,pBuffer,unBufferSize,bRESERVED_MUST_BE_FALSE);
	return result;
}
public override bool GenerateItems(ref int pResultHandle,int [] pArrayItemDefs,uint [] punArrayQuantity)
{
	CheckIfUsable();
	pResultHandle = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamInventory_GenerateItems(m_SteamInventory,ref pResultHandle,pArrayItemDefs,punArrayQuantity,(uint) punArrayQuantity.Length);
	return result;
}
public override bool GrantPromoItems(ref int pResultHandle)
{
	CheckIfUsable();
	pResultHandle = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamInventory_GrantPromoItems(m_SteamInventory,ref pResultHandle);
	return result;
}
public override bool AddPromoItem(ref int pResultHandle,int itemDef)
{
	CheckIfUsable();
	pResultHandle = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamInventory_AddPromoItem(m_SteamInventory,ref pResultHandle,itemDef);
	return result;
}
public override bool AddPromoItems(ref int pResultHandle,int [] pArrayItemDefs)
{
	CheckIfUsable();
	pResultHandle = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamInventory_AddPromoItems(m_SteamInventory,ref pResultHandle,pArrayItemDefs,(uint) pArrayItemDefs.Length);
	return result;
}
public override bool ConsumeItem(ref int pResultHandle,ulong itemConsume,uint unQuantity)
{
	CheckIfUsable();
	pResultHandle = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamInventory_ConsumeItem(m_SteamInventory,ref pResultHandle,itemConsume,unQuantity);
	return result;
}
public override bool ExchangeItems(ref int pResultHandle,int [] pArrayGenerate,uint [] punArrayGenerateQuantity,ulong [] pArrayDestroy,uint [] punArrayDestroyQuantity)
{
	CheckIfUsable();
	pResultHandle = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamInventory_ExchangeItems(m_SteamInventory,ref pResultHandle,pArrayGenerate,punArrayGenerateQuantity,(uint) punArrayGenerateQuantity.Length,pArrayDestroy,punArrayDestroyQuantity,(uint) punArrayDestroyQuantity.Length);
	return result;
}
public override bool TransferItemQuantity(ref int pResultHandle,ulong itemIdSource,uint unQuantity,ulong itemIdDest)
{
	CheckIfUsable();
	pResultHandle = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamInventory_TransferItemQuantity(m_SteamInventory,ref pResultHandle,itemIdSource,unQuantity,itemIdDest);
	return result;
}
public override void SendItemDropHeartbeat()
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamInventory_SendItemDropHeartbeat(m_SteamInventory);
}
public override bool TriggerItemDrop(ref int pResultHandle,int dropListDefinition)
{
	CheckIfUsable();
	pResultHandle = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamInventory_TriggerItemDrop(m_SteamInventory,ref pResultHandle,dropListDefinition);
	return result;
}
public override bool TradeItems(ref int pResultHandle,ulong steamIDTradePartner,ulong [] pArrayGive,uint [] pArrayGiveQuantity,ulong [] pArrayGet,uint [] pArrayGetQuantity)
{
	CheckIfUsable();
	pResultHandle = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamInventory_TradeItems(m_SteamInventory,ref pResultHandle,steamIDTradePartner,pArrayGive,pArrayGiveQuantity,(uint) pArrayGiveQuantity.Length,pArrayGet,pArrayGetQuantity,(uint) pArrayGetQuantity.Length);
	return result;
}
public override bool LoadItemDefinitions()
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamInventory_LoadItemDefinitions(m_SteamInventory);
	return result;
}
public override bool GetItemDefinitionIDs(out int [] pItemDefIDs)
{
	...
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamInventory_GetItemDefinitionIDs(m_SteamInventory,null,ref punItemDefIDsArraySize);
	pItemDefIDs= new int[punItemDefIDsArraySize];
	 result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamInventory_GetItemDefinitionIDs(m_SteamInventory,pItemDefIDs,ref punItemDefIDsArraySize);
	return result;
}
public override bool GetItemDefinitionProperty(int iDefinition,string pchPropertyName,out string pchValueBuffer)
{
	...
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamInventory_GetItemDefinitionProperty(m_SteamInventory,iDefinition,pchPropertyName,null,ref punValueBufferSize);
	System.Text.StringBuilder pStrBuffer = new System.Text.StringBuilder((int)punValueBufferSize);
	 result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamInventory_GetItemDefinitionProperty(m_SteamInventory,iDefinition,pchPropertyName,pStrBuffer,ref punValueBufferSize);
...
public override IntPtr GetIntPtr() { return m_SteamVideo; }

private void CheckIfUsable()
{
	if (m_SteamVideo == IntPtr.Zero)
	{
		throw new Exception("Steam Pointer not configured");
	}
}
...
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamVideo_GetVideoURL(m_SteamVideo,unVideoAppID);
}
}
...
IntPtr m_SteamGameServer;

public override IntPtr GetIntPtr() { return m_SteamGameServer; }

private void CheckIfUsable()
{
	if (m_SteamGameServer == IntPtr.Zero)
	{
		throw new Exception("Steam Pointer not configured");
	}
}
...
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_InitGameServer(m_SteamGameServer,unIP,usGamePort,usQueryPort,unFlags,nGameAppId,pchVersionString);
	return result;
}
public override void SetProduct(string pszProduct)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_SetProduct(m_SteamGameServer,pszProduct);
}
public override void SetGameDescription(string pszGameDescription)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_SetGameDescription(m_SteamGameServer,pszGameDescription);
}
public override void SetModDir(string pszModDir)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_SetModDir(m_SteamGameServer,pszModDir);
}
public override void SetDedicatedServer(bool bDedicated)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_SetDedicatedServer(m_SteamGameServer,bDedicated);
}
public override void LogOn(string pszToken)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_LogOn(m_SteamGameServer,pszToken);
}
public override void LogOnAnonymous()
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_LogOnAnonymous(m_SteamGameServer);
}
public override void LogOff()
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_LogOff(m_SteamGameServer);
}
public override bool BLoggedOn()
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_BLoggedOn(m_SteamGameServer);
	return result;
}
public override bool BSecure()
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_BSecure(m_SteamGameServer);
	return result;
}
public override ulong GetSteamID()
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_GetSteamID(m_SteamGameServer);
	return result;
}
public override bool WasRestartRequested()
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_WasRestartRequested(m_SteamGameServer);
	return result;
}
public override void SetMaxPlayerCount(int cPlayersMax)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_SetMaxPlayerCount(m_SteamGameServer,cPlayersMax);
}
public override void SetBotPlayerCount(int cBotplayers)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_SetBotPlayerCount(m_SteamGameServer,cBotplayers);
}
public override void SetServerName(string pszServerName)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_SetServerName(m_SteamGameServer,pszServerName);
}
public override void SetMapName(string pszMapName)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_SetMapName(m_SteamGameServer,pszMapName);
}
public override void SetPasswordProtected(bool bPasswordProtected)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_SetPasswordProtected(m_SteamGameServer,bPasswordProtected);
}
public override void SetSpectatorPort(char unSpectatorPort)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_SetSpectatorPort(m_SteamGameServer,unSpectatorPort);
}
public override void SetSpectatorServerName(string pszSpectatorServerName)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_SetSpectatorServerName(m_SteamGameServer,pszSpectatorServerName);
}
public override void ClearAllKeyValues()
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_ClearAllKeyValues(m_SteamGameServer);
}
public override void SetKeyValue(string pKey,string pValue)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_SetKeyValue(m_SteamGameServer,pKey,pValue);
}
public override void SetGameTags(string pchGameTags)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_SetGameTags(m_SteamGameServer,pchGameTags);
}
public override void SetGameData(string pchGameData)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_SetGameData(m_SteamGameServer,pchGameData);
}
public override void SetRegion(string pszRegion)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_SetRegion(m_SteamGameServer,pszRegion);
}
...
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_SendUserConnectAndAuthenticate(m_SteamGameServer,unIPClient,pvAuthBlob,cubAuthBlobSize,ref pSteamIDUser);
	return result;
}
public override ulong CreateUnauthenticatedUserConnection()
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_CreateUnauthenticatedUserConnection(m_SteamGameServer);
	return result;
}
public override void SendUserDisconnect(ulong steamIDUser)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_SendUserDisconnect(m_SteamGameServer,steamIDUser);
}
public override bool BUpdateUserData(ulong steamIDUser,string pchPlayerName,uint uScore)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_BUpdateUserData(m_SteamGameServer,steamIDUser,pchPlayerName,uScore);
	return result;
}
public override uint GetAuthSessionTicket(IntPtr pTicket,int cbMaxTicket,ref uint pcbTicket)
{
	CheckIfUsable();
	pcbTicket = 0;
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_GetAuthSessionTicket(m_SteamGameServer,pTicket,cbMaxTicket,ref pcbTicket);
	return result;
}
public override uint BeginAuthSession(IntPtr pAuthTicket,int cbAuthTicket,ulong steamID)
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_BeginAuthSession(m_SteamGameServer,pAuthTicket,cbAuthTicket,steamID);
	return result;
}
public override void EndAuthSession(ulong steamID)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_EndAuthSession(m_SteamGameServer,steamID);
}
public override void CancelAuthTicket(uint hAuthTicket)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_CancelAuthTicket(m_SteamGameServer,hAuthTicket);
}
public override uint UserHasLicenseForApp(ulong steamID,uint appID)
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_UserHasLicenseForApp(m_SteamGameServer,steamID,appID);
	return result;
}
public override bool RequestUserGroupStatus(ulong steamIDUser,ulong steamIDGroup)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_RequestUserGroupStatus(m_SteamGameServer,steamIDUser,steamIDGroup);
	return result;
}
public override void GetGameplayStats()
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_GetGameplayStats(m_SteamGameServer);
}
public override ulong GetServerReputation()
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_GetServerReputation(m_SteamGameServer);
	return result;
}
public override uint GetPublicIP()
{
	CheckIfUsable();
	uint result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_GetPublicIP(m_SteamGameServer);
	return result;
}
public override bool HandleIncomingPacket(IntPtr pData,int cbData,uint srcIP,char srcPort)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_HandleIncomingPacket(m_SteamGameServer,pData,cbData,srcIP,srcPort);
	return result;
}
public override int GetNextOutgoingPacket(IntPtr pOut,int cbMaxOut,ref uint pNetAdr,ref char pPort)
{
	...
	pNetAdr = 0;
	pPort = (char) 0;
	int result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_GetNextOutgoingPacket(m_SteamGameServer,pOut,cbMaxOut,ref pNetAdr,ref pPort);
	return result;
}
public override void EnableHeartbeats(bool bActive)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_EnableHeartbeats(m_SteamGameServer,bActive);
}
public override void SetHeartbeatInterval(int iHeartbeatInterval)
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_SetHeartbeatInterval(m_SteamGameServer,iHeartbeatInterval);
}
public override void ForceHeartbeat()
{
	CheckIfUsable();
	Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_ForceHeartbeat(m_SteamGameServer);
}
public override ulong AssociateWithClan(ulong steamIDClan)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_AssociateWithClan(m_SteamGameServer,steamIDClan);
	return result;
}
public override ulong ComputeNewPlayerCompatibility(ulong steamIDNewPlayer)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServer_ComputeNewPlayerCompatibility(m_SteamGameServer,steamIDNewPlayer);
	return result;
}
}
...
IntPtr m_SteamGameServerStats;

public override IntPtr GetIntPtr() { return m_SteamGameServerStats; }

private void CheckIfUsable()
{
	if (m_SteamGameServerStats == IntPtr.Zero)
	{
		throw new Exception("Steam Pointer not configured");
	}
}
...
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServerStats_RequestUserStats(m_SteamGameServerStats,steamIDUser);
	return result;
}
public override bool GetUserStat(ulong steamIDUser,string pchName,ref int pData)
{
	CheckIfUsable();
	pData = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServerStats_GetUserStat(m_SteamGameServerStats,steamIDUser,pchName,ref pData);
	return result;
}
public override bool GetUserStat0(ulong steamIDUser,string pchName,ref float pData)
{
	CheckIfUsable();
	pData = 0;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServerStats_GetUserStat0(m_SteamGameServerStats,steamIDUser,pchName,ref pData);
	return result;
}
public override bool GetUserAchievement(ulong steamIDUser,string pchName,ref bool pbAchieved)
{
	CheckIfUsable();
	pbAchieved = false;
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServerStats_GetUserAchievement(m_SteamGameServerStats,steamIDUser,pchName,ref pbAchieved);
	return result;
}
public override bool SetUserStat(ulong steamIDUser,string pchName,int nData)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServerStats_SetUserStat(m_SteamGameServerStats,steamIDUser,pchName,nData);
	return result;
}
public override bool SetUserStat0(ulong steamIDUser,string pchName,float fData)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServerStats_SetUserStat0(m_SteamGameServerStats,steamIDUser,pchName,fData);
	return result;
}
...
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServerStats_UpdateUserAvgRateStat(m_SteamGameServerStats,steamIDUser,pchName,flCountThisSession,dSessionLength);
	return result;
}
public override bool SetUserAchievement(ulong steamIDUser,string pchName)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServerStats_SetUserAchievement(m_SteamGameServerStats,steamIDUser,pchName);
	return result;
}
public override bool ClearUserAchievement(ulong steamIDUser,string pchName)
{
	CheckIfUsable();
	bool result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServerStats_ClearUserAchievement(m_SteamGameServerStats,steamIDUser,pchName);
	return result;
}
public override ulong StoreUserStats(ulong steamIDUser)
{
	CheckIfUsable();
	ulong result = Valve.Interop.NativeEntrypoints.SteamAPI_ISteamGameServerStats_StoreUserStats(m_SteamGameServerStats,steamIDUser);
	return result;
}
}
...
[StructLayout(LayoutKind.Sequential)] public struct RemoteStorageDownloadUGCResult_t
{
	...
	[MarshalAs(UnmanagedType.ByValArray, SizeConst = 260, ArraySubType = UnmanagedType.I1)]
	public char[] m_chFileName; //char[260]
...
{
	public ISteamUser m_SteamUser;
	public ISteamFriends m_SteamFriends;
	public ISteamUtils m_SteamUtils;
	public ISteamMatchmaking m_SteamMatchmaking;
	public ISteamUserStats m_SteamUserStats;
	public ISteamApps m_SteamApps;
	public ISteamMatchmakingServers m_SteamMatchmakingServers;
	public ISteamNetworking m_SteamNetworking;
	public ISteamRemoteStorage m_SteamRemoteStorage;
	public ISteamScreenshots m_SteamScreenshots;
	public ISteamHTTP m_SteamHTTP;
	public ISteamUnifiedMessages m_SteamUnifiedMessages;
	public ISteamController m_Controller;
	public ISteamUGC m_SteamUGC;
	public ISteamAppList m_SteamAppList;
	public ISteamMusic m_SteamMusic;
	public ISteamMusicRemote m_SteamMusicRemote;
	public ISteamHTMLSurface m_SteamHTMLSurface;
	public ISteamInventory m_SteamInventory;
	public ISteamVideo m_SteamVideo;
}
...
[StructLayout(LayoutKind.Sequential)] public struct GSClientAchievementStatus_t
{
	public ulong m_SteamID;
	[MarshalAs(UnmanagedType.ByValArray, SizeConst = 128, ArraySubType = UnmanagedType.I1)]
	public char[] m_chAchievement; //char[128]
